...
>
> - [ AS Biology Vocabulary.pdf](https://gitee.com/tomthethuan/as-biology-selfnotes/releases/download/final/AS%20Biology%20Vocabulary.pdf)
> - [ Protein Structure Levels Summary.pdf](https://gitee.com/tomthethuan/as-biology-selfnotes/releases/download/final/Protein%20Structure%20Levels%20Summary.pdf)
...
如果要查看每个版本更新的内容的话可以在这个地方看到：[commits](https://gitee.com/tomthethuan/as-biology-selfnotes/commits/master)

如果要找我之前发的PDF版本：[releases](https://gitee.com/tomthethuan/as-biology-selfnotes/releases)
...
| <u>underline</u> | must be used by the candidate          | 一定要用的单词                 |
...
完整版笔记目录：[TOC](#table-of-content)

#### Chapter 1 Cell structure 细胞结构

- [x] 1.1 Cells are the basic units of life 细胞是生命的基本单位
- [x] 1.2 Cell biology and microscopy 细胞生物学与显微镜技术
- [x] 1.3 Plant and animal cells as seen with a light microscope 光学显微镜下的动植物细胞
- [x] 1.4 Measuring size and calculating magnification 尺寸测量与放大倍数计算
- [x] 1.5 Electron microscopy 电子显微镜
- [x] 1.6 Plant and animal cells as seen with an electron microscope 电子显微镜下的动植物细胞
- [x] 1.7 Bacteria 细菌
- [x] 1.8 Comparing prokaryotic cells with eukaryotic cells 原核细胞与真核细胞的比较
- [x] 1.9 Viruses 病毒

#### Chapter 2 Biological molecules 生物分子

- [x] 2.1 Biochemistry 生物化学
- [x] 2.2 The building blocks of life 生命的构建模块
- [x] 2.3 Monomers, polymers and macromolecules 单体、聚合物和大分子
- [x] 2.4 Carbohydrates 碳水化合物
- [x] 2.5 Lipids 脂质
- [x] 2.6 Proteins 蛋白质
- [x] 2.7 Water 水
...
- [x] 3.1 What is an enzyme? 什么是酶？
- [x] 3.2 Mode of action of enzymes 酶的作用模式
- [x] 3.3 Investigating the progress of an enzyme-catalysed reaction 研究酶催化反应进程
- [x] 3.4 Factors that affect enzyme action 影响酶作用的因素
- [x] 3.5 Comparing enzyme affinities 比较酶亲和力
- [x] 3.6 Enzyme inhibitors 酶抑制剂
- [x] 3.7 Immobilising enzymes 固定化酶

#### Chapter 4 Cell membranes and transport 细胞膜与运输

- [x] 4.1 The importance of membranes 膜的重要性
- [x] 4.2 Structure of membranes 膜的结构
- [x] 4.3 Roles of the molecules found in membranes 膜中分子的作用
- [x] 4.4 Cell signalling 细胞信号传导
- [x] 4.5 Movement of substances across membranes 物质跨膜运输

#### Chapter 5 The mitotic cell cycle 有丝分裂细胞周期

- [x] 5.1 Growth and reproduction 生长与繁殖
- [x] 5.2 Chromosomes 染色体
- [x] 5.3 The cell cycle 细胞周期
- [x] 5.4 Mitosis 有丝分裂
- [x] 5.5 The role of telomeres 端粒的作用
- [x] 5.6 The role of stem cells 干细胞的作用
- [x] 5.7 Cancers 癌症

#### Chapter 6 Nucleic acids and protein synthesis 核酸与蛋白质合成

- [x] 6.1 The molecule of life 生命分子
- [x] 6.2 The structure of DNA and RNA DNA和RNA的结构
- [x] 6.3 DNA replication DNA复制
- [x] 6.4 The genetic code 遗传密码
- [x] 6.5 Protein synthesis 蛋白质合成
- [x] 6.6 Gene mutations 基因突变

#### Chapter 7 Transport in plants 植物运输

- [x] 7.1 The transport needs of plants 植物的运输需求
- [x] 7.2 Vascular system: xylem and phloem 维管系统：木质部与韧皮部
- [x] 7.3 Structure of stems, roots and leaves and the distribution of xylem and phloem 茎、根、叶的结构及维管分布
- [x] 7.4 The transport of water 水分运输
- [x] 7.5 Transport of assimilates 同化物的运输

#### Chapter 8 Transport in mammals 哺乳动物运输

- [x] 8.1 Transport systems in animals 动物的运输系统
- [x] 8.2 The mammalian circulatory system 哺乳动物循环系统
- [x] 8.3 Blood vessels 血管
- [x] 8.4 Tissue fluid 组织液
- [x] 8.5 Blood 血液
- [x] 8.6 The heart 心脏

#### Chapter 9 Gas exchange 气体交换

- [x] 9.1 Gas exchange 气体交换
- [x] 9.2 Lungs 肺
- [x] 9.3 Trachea, bronchi and bronchioles 气管、支气管和细支气管
- [x] 9.4 Warming and cleaning the air 空气的加温与清洁
- [x] 9.5 Alveoli 肺泡

#### Chapter 10 Infectious disease 传染病

- [x] 10.1 Infectious diseases 传染病
- [x] 10.2 Antibiotics 抗生素

#### Chapter 11 Immunity 免疫

- [x] 11.1 Defence against disease 疾病防御
- [x] 11.2 Cells of the immune system 免疫系统细胞
- [x] 11.3 Active and passive immunity 主动免疫与被动免疫
...
- 克隆本仓库或直接[下载ZIP](https://gitee.com/tomthethuan/as-biology-selfnotes/repository/archive/master.zip)
- 可直接打开 `.md` 文件进行阅读（推荐使用 Markdown 编辑器如 Typora）。
- 图片资源文件夹中的图像用于对应章节的图文说明，无需单独操作。

### 许可协议

本项目遵循开源精神，如无特别说明，所有内容均可自由使用与传播。如发现内容引用涉及版权问题，请联系仓库维护者处理。

如需贡献内容或提出建议，请提交 Issue 或 Pull Request。

## Chapter 1 - Cell Organelles
...
- Transmission Electron Microscope 穿透电子显微镜: 2D image, can see interior details 可以呈现出2D的图像，并且可以看到细胞内的结构。
  ...
  > <img src="./Chapter-1.assets/image-20250917194602321.png" alt="image-20250917194602321" style="zoom:33%;" />

- Scanning Electron Microscope 扫描电子显微镜: 3D image, can only see surface structures 可以看到细胞表面的3D结构。

  > <img src="./Chapter-1.assets/image-20250917194532790.png" alt="image-20250917194532790" style="zoom:33%;" />
...
![image-20250910195140204](/home/thuan/.config/Typora/typora-user-images/image-20250910195140204.png)
...
5. Golgi body (Golgi apparatus or Golgi complex)
6. mitochondria (including the presence of small circular DNA)
7. ribosomes (80S in the cytoplasm and 70S in chloroplasts
8. and mitochondria)
9. lysosomes
10. centrioles and microtubules
11. cilia
12. microvilli
13. chloroplasts (including the presence of small circular DNA)
14. cell wall
15. plasmodesmata
16. large permanent vacuole and tonoplast of plant cells
```
...
- DNA contains the instructions / genes that control the activities of the cell, e.g. control **protein synthesis**
  ...
  DNA含有细胞活动的指令（或基因），可以控制包括**蛋白质合成**等一系列活动
...
| **主要功能** | 进行DNA的复制和转录（指导蛋白质合成） | 确保DNA被**精确分配**到子细胞中  |
| **可视性**   | 在光学显微镜下通常**不可见**          | 在光学显微镜下**清晰可见**       |

![image-20250910211311796](./Chapter-1.assets/image-20250910211311796.png)
...
![image-20250910213828024](./Chapter-1.assets/image-20250910213828024.png)
...
![image-20250910214457466](./Chapter-1.assets/image-20250910214457466.png)

ATP分子遇到水分子时会发生水解反应（Hydrolysis）：To break bonds between phosphate groups and release energy. 当分子间的化学键断裂时会释放能量。

![image-20250910215019205](./Chapter-1.assets/image-20250910215019205.png)
...
![image-20250910215723096](./Chapter-1.assets/image-20250910215723096.png)
...
![image-20250911101340099](./Chapter-1.assets/image-20250911101340099.png)
...
![image-20250911102121096](./Chapter-1.assets/image-20250911102121096.png)

Smooth ER lacks ribosomes, the membrane of smooth ER is not continuous with the outer membrane of the nuclear envelope. <u>It makes lipids and steroids</u>, and it's also the major storage site for calcium ions.

光滑内质网几乎没有核糖体，并且它的膜并不与细胞核相连。它负责<u>生产脂质和类固醇</u>，它还是储存钙离子的主要地方。
...
高尔基体由**囊泡**构成，会在**粗面内质网**的一端生成，并且在另一端被分解成**高尔基小泡**

> 在Goblet cell中含有**大量的**Golgi bodies，Goblet cell需要产生大量的分泌物
...
![image-20250911110824421](./Chapter-1.assets/image-20250911110824421.png)
...
<img src="./Chapter-1.assets/image-20250911214930677.png" alt="image-20250911214930677" style="zoom:50%;" />
...
<img src="./Chapter-1.assets/image-20250911215937028.png" alt="image-20250911215937028" style="zoom: 67%;" /><img src="./Chapter-1.assets/image-20250911220210034.png" alt="image-20250911220210034" style="zoom:67%;" />

![image-20250911220721691](./Chapter-1.assets/image-20250911220721691.png)
...
Microtubules are made of a protein called **tubulin**. Tubulin has two forms, α-tubulin (alpha-tubulin) and β-tubulin (beta-tubulin). 微管由一种叫做**微管蛋白**的蛋白质构成，微管蛋白有两种形态，α和β。

1. α- and β-tubulin molecules combine to form **dimers** (double molecules) α-和β-微管蛋白分子结合形成“二聚体”（一种双分子结构）<img src="./Chapter-1.assets/image-20250911221852601.png" alt="image-20250911221852601" style="zoom:80%;" />
2. These dimers are then joined end to end to form long ‘**protofilaments**’. 这些“二聚体”随后端对端连接形成长的“原丝”。<img src="./Chapter-1.assets/image-20250911222103262.png" alt="image-20250911222103262" style="zoom:33%;" />
...
3. Thirteen protofilaments line up alongside each other in a ring to form a cylinder with a hollow centre. 十三个原纤维平行排列成环，形成一个中间空心的圆柱。<img src="./Chapter-1.assets/image-20250911222215169.png" alt="image-20250911222215169" style="zoom:33%;" />
4. This cylinder is the microtubule. 这个圆柱体就是微管

![image-20250911221604282](./Chapter-1.assets/image-20250911221604282.png)

Microtubules make up the cytoskeleton, which helps to determine cell shape. 微管构成细胞骨架，帮助决定细胞形状。

<img src="./Chapter-1.assets/image-20250911223051822.png" alt="image-20250911223051822" style="zoom: 50%;" />
...
- Microtubules form part of the structure of centrioles 形成中心粒的部分结构
  ...
  >
  > <img src="./Chapter-1.assets/image-20250911223929551.png" alt="image-20250911223929551" style="zoom: 67%;" />
  >
...
<img src="./Chapter-1.assets/image-20250911221107442.png" alt="image-20250911221107442"  />
...
![image-20250914222420023](./Chapter-1.assets/image-20250914222420023.png)
...
![image-20250914224029088](./Chapter-1.assets/image-20250914224029088.png)
...
![image-20250914224505143](./Chapter-1.assets/image-20250914224505143.png)
...
- Generally 1~5 μm (diameter) 直径大约在1~5微米
...
![image-20250914225611158](./Chapter-1.assets/image-20250914225611158.png)
...
| **环状DNA**，**游离**于细胞质中    | 具有由核被膜（双层膜）包裹的**细胞核**           |
| 70S核糖体                          | 含有70S和80S核糖体                               |
...
![image-20250915111248506](./Chapter-1.assets/image-20250915111248506.png)
...
这是我目前主要放笔记的地方：[as-biology-selfnotes](https://gitee.com/tomthethuan/as-biology-selfnotes)
...
- Monomers到Polymer称作**Condensation**

- Polymer到Monomers称作**Hydrolysis**

$$
\ce{Monomers ->[Condensation] Polymer}
$$

$$
\ce{Polymer ->[Hydrolysis] Monomers}
$$
...
如果有两种分子的<u>结构不同但组成它们的元素相同</u>，它们被称为**异构体**。例如：
...
![image-20250924165531507](./Chapter-2.assets/image-20250924165531507.png)

当一个化合物中的电子分布不均匀时，会导致这个化合物的一部分带正电，或者一部分带负电。当电子集中在一端时，这一侧会产生**负电**（因为电子带负电荷）。

> 共价键会导致`氧`和`氢`之间的分子集中在一个地方：
...
![image-20250924170034461](./Chapter-2.assets/image-20250924170034461.png)

对于水分子来说，大部分都电子都集中在“靠上”的地方，导致那部分区域带有负电（左图），所以那一侧会被标记为`δ-`（右图）；对于氢原子的那一侧同理。

<img src="./Chapter-2.assets/water.svg" alt="water" />
...
当一个水分子的`δ+`与另一个水分子的`δ-`相互吸引时，会形成“氢键”（一般在图中用虚线表示）。

![image-20250924170431255](./Chapter-2.assets/image-20250924170431255.png)

Dipoles occur in many different molecules, particularly where there is an `–OH`, `–C=O` or `–NH` group having polar covalent bond. 由于共价键会形成于很多种分子中（例如包含`–OH`、`–C=O`或`–NH`的分子中），这些不均匀分布的电子会导致产生具有“极性”的。
...
Water is polar , which can <u>attracted to ions and polar molecules</u> (include some carbohydrates and proteins). Chemicals like <u>ions, polar molecules, gasses and waste products (e.g. ammonia and uera)</u> dissolve in water.
...
![image-20251005232439517](./Chapter-2.assets/image-20251005232439517.png)

### Carbohydrates 碳水化合物

碳水化合物从名字上来看的话就是`碳`和`水`之间的化合物，也就是说碳水化合物中包括三种元素：
...
> 其中`x`指的是碳原子的数量，而`y`指的是水分子的数量。

根据**糖分子**数量的不同，碳水化合物可以被分为三个大类：
...
其中Pentoses中具有代表性的**糖**有：Ribose和Deoxyribose
...
<img src="./Chapter-2.assets/image-20250916132813934.png" alt="image-20250916132813934" style="zoom:80%;" />

![image-20250916132854532](./Chapter-2.assets/image-20250916132854532.png)

> Isomers of glucose: same linear structure but different ring structure.
>
> 可以看到在Glucose环成Ring Structure时，OH的方向会不一样，所以会有**α-glucose**和**β-glucose**之分。
>
> - α-glucose: OH is **below** the ring (**DDUDU**) - $\alpha \rightarrow B$
> - β-glucose: OH is **above** the ring (**UDUDU**) - $\beta \rightarrow A$
>
...
Defination of **sugar**: Soluble and taste **sweet** 可溶于水，并且是**甜**的。

> 所以说只有单糖和双糖能算是“糖”

由两个Monosaccharides通过**glycosidic bond**组成，最常见的有：
...
- Sucrose (glucose + fructose) 蔗糖
  ...
  > [!IMPORTANT]
  >
  > Sucrose**不是**reducing sugar，无法通过Benedict's test，但是经过acid hydrolysis后会产生reducing sugar
...
![image-20250916140105235](./Chapter-2.assets/image-20250916140105235.png)

> Glycosidic bond: a C–O–C link between two sugar molecules, formed by a condensation reaction; it is a **covalent bond** 共价键.
>
> $$
> \ce{α-glucose + β-glucose ->[condensation] sucrose + water}
> $$

当两个单糖通过condensation形成双糖时，**glycosidic bond**和**水分子**会产生。由于只有两个单糖，所以双糖并不算Polymer。
...
![image-20250918180549338](./Chapter-2.assets/image-20250918180549338.png)
...
![image-20250918180915796](./Chapter-2.assets/image-20250918180915796.png)
...
<u>"1, 4 glycosidic bond"</u> 表示一个glucose上第一个**C**和另一个glucose上第四个**C**相连：

![image-20250918182907353](./Chapter-2.assets/image-20250918182907353.png)![image-20250918182609017](./Chapter-2.assets/image-20250918182609017.png)
...
![image-20250918181952608](./Chapter-2.assets/image-20250918181952608.png)
...
<u>1, 6 glycosidic bond</u>：

![image-20250918183037229](./Chapter-2.assets/image-20250918183037229.png)
...
<table>
        ...
        <tbody>
            <tr>
                <td>Monomer Unit</td>
                <td colspan="2", style="text-align: center;">α-glucose</td>
            </tr>
            <tr>
                <td>Primary Linkage</td>
                <td colspan="2", style="text-align: center;">1,4-glycosidic bonds</td>
            </tr>
            <tr>
                <td>Biological Function</td>
                <td colspan="2", style="text-align: center;">Energy storage in plants (components of starch)</td>
            </tr>
            <tr>
                <td>Molecular Structure</td>
                <td>Linear, unbranched chain</td>
                <td>Branched chain</td>
            </tr>
            <tr>
                <td>Branching Linkage</td>
                <td>None</td>
                <td>1,6-glycosidic bonds (every 24-30 glucose units)</td>
            </tr>
            <tr>
                <td>Chain Length</td>
                <td>Long (several thousand glucose units)</td>
                <td>Shorter chains (compared to amylose)</td>
            </tr>
            <tr>
                <td>Shape in Space</td>
                <td>Coils into a helix</td>
                <td>Bushy, dendritic structure</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Digestion Rate</td>
                <td>Slower to digest</td>
                <td>Faster to digest (more ends for enzymes to attack)</td>
            </tr>
            <tr>
                <td>Percentage in Starch</td>
                <td>~20-30%</td>
                <td>~70-80%</td>
            </tr>
        </tbody>
...
<table> <thead> <tr> <th>特性</th> <th>直链淀粉 (Amylose)</th> <th>支链淀粉 (Amylopectin)</th> </tr> </thead> <tbody> <tr> <td>单体单位</td> <td colspan="2", style="text-align: center;">α-葡萄糖</td> </tr> <tr> <td>主要连接键</td> <td colspan="2", style="text-align: center;">1,4-糖苷键</td> </tr> <tr> <td>生物功能</td> <td colspan="2", style="text-align: center;">植物中的能量储存（淀粉的组成部分）</td> </tr> <tr> <td>分子结构</td> <td>线性，无支链</td> <td>有支链</td> </tr> <tr> <td>分支连接键</td> <td>无</td> <td>1,6-糖苷键（每24-30个葡萄糖单元出现一次）</td> </tr> <tr> <td>链长</td> <td>长（数千个葡萄糖单元）</td> <td>链较短（与直链淀粉相比）</td> </tr> <tr> <td>空间形状</td> <td>卷曲成螺旋状</td> <td>树枝状结构</td> </tr> <tr> <td>水溶性</td> <td>溶解度较低</td> <td>溶解度较高</td> </tr> <tr> <td>消化速率</td> <td>消化较慢</td> <td>消化较快（有更多末端供酶作用）</td> </tr> <tr> <td>在淀粉中的占比</td> <td>~20-30%</td> <td>~70-80%</td> </tr> </tbody> </table>
...
- Even more **branched** than amylopectin
  ...
  <img src="./Chapter-2.assets/image-20250918183553198.png" alt="image-20250918183553198" style="zoom:67%;" />
...
![image-20250918212954950](./Chapter-2.assets/image-20250918212954950.png)
...
> **soluble:**
>
> 1. increase concentration in cell
> 2. water would enter
> 3. cell volume increase, animal cells may brust
>
...
<img src="./Chapter-2.assets/image-20250918221932638.png" alt="image-20250918221932638" style="zoom:67%;" />

![image-20250918222017208](./Chapter-2.assets/image-20250918222017208.png)
...
<table>
        ...
        <tbody>
            <tr>
                <td class="characteristic">Glucose Type</td>
                <td>β-glucose</td>
                <td class="merged" colspan="3" style="text-align: center;">α-glucose</td>
            </tr>
            <tr>
                <td class="characteristic">Structure</td>
                <td>Unbranched, straight chain</td>
                <td>Unbranched, helical</td>
                <td>Branched</td>
                <td>More branched than amylopectin</td>
            </tr>
            <tr>
                <td class="characteristic">Origin</td>
                <td class="merged" colspan="2" style="text-align: center;">Plant</td>
                <td class="merged" colspan="2" style="text-align: center;">Animal</td>
            </tr>
            <tr>
                <td class="characteristic">Linkage</td>
                <td>β-1,4 linkage</td>
                <td>α-1,4 linkage</td>
                <td class="merged" colspan="2" style="text-align: center;">α-1,4 and α-1,6 linkage</td>
            </tr>
            <tr>
                <td class="characteristic">Hydrogen Bonds Present</td>
                <td>Yes, in the molecule and between molecules</td>
                <td class="merged" colspan="3" style="text-align: center;">No</td>
            </tr>
        </tbody>
  </table>
...
Colour change: <span style="color: #8B4513; background-color: #FFFFFF; border-radius: 8px; padding: 2px;">Orange-brown</span> → <span style="color: #191970; background-color: #FFFFFF; border-radius: 8px; padding: 2px;">Bule Black</span>
...
$$
\ce{Reducing Sugar + Cu^2+ -> Oxidised Sugar + Cu+ }
$$

Colour of the solution: <span style="color: #87CEEB;">Blue</span> → <span style="color: #CB4154;">Brick Red</span>.

> **Semi-quantitative** Benedict's test 半定量的本尼迪克测试:
>
> 1. setup standard solutions with **known concentration** of reducing sugar
>
>    配置一系列已知浓度的溶液
>
> 2. use the standard as **colour scale** which can be used to compare with the unknow solution
>
>    通过这些已知的溶液做出一个比色标尺，由浅到深（蓝色→绿色→黄色→橙色→砖红色）
>
> 3. use **colorimeter 色度计** to measure the **light absorbance 吸光度** by each solution
>
>    可以通过色度计来准确地测量颜色（避免肉眼观察的偏差）
>
> 4. A graph of concentration against light absorbance can be plotted
>
>    通过画图的方式来较为准确地估算浓度
...
1. Do the Benedict's Test first, if the colour dosen't change, so the reducing sugar is not present

   首先先对未知的溶液做Benedict's Test，如果颜色没有改变，说明这个溶液里没有reducing sugar

2. <u>Add **acid** to another sample in test tube</u> and <u>**heat** it in water bath</u> (to **hydrolyse** non-reducing sugar into monosaccharides)

   <u>将**酸**加入同样的溶液</u>（但是没有做过Benedict's Test），并<u>在水浴锅中加热</u>（用于水解非还原糖到**单糖**）

3. **Neutralise** the solution by adding an alkali (e.g. NaOH)

   **中和**第二步中产生的溶液

4. Carry out Benedict's Test on the sample again

   对新产生的溶液重新做Benedict's Test

> Result 实验结果:
>
> - <span style="color: #CB4154;">Brick Red</span> precipitate - Non-reducing sugar present 有*非还原糖*
> - Remain <span style="color: #87CEEB; background-color: #FFFFFF; border-radius: 8px;"> blue colour </span> - Not a sugar 无*非还原糖*（因为还原糖和非还原糖都没有，所以这个样本中没有糖）
...
| ![image-20250924135524995](./Chapter-2.assets/image-20250924135524995.png) | <img src="./Chapter-2.assets/image-20250924135347674.png" alt="image-20250924135347674" style="zoom:80%;" /> |

Fatty acid's hydrocarbon chain is **hydrophobic** and **non-polar**.

因为脂肪酸是**疏水**并且是**非极性**的，所以它不会溶于水。polar的物质只会溶于polar的液体：水是polar的，而脂肪酸是non-polar的，所以二者不会相溶。
...
![image-20250924135823840](./Chapter-2.assets/image-20250924135823840.png)

**饱和**指的是所有中间的`C`都与4个其他原子相连（没有双键），如果有双键就是**非饱和**。
...
| ------------ | --------------------------------- | ------------------------------------- |
| 分子形状     | 直链 - **能**紧密排列             | 有弯折（非直链）- **不能**紧密排列    |
...
![image-20250925110556446](./Chapter-2.assets/image-20250925110556446.png)
...
- Store of energy
  ...
  > Triglycerides contain many `C-H` bonds that can use to store energy, also it has higher energy density than carbohydrates and proteins (large mass per unit volume). `C-H`键可以储存大量的能量，并且因为它排列紧密，所以它的能量密度很高。
...
![image-20250925112244878](./Chapter-2.assets/image-20250925112244878.png)
...
1. Add ethanol to the sample (in test tube) 添加乙醇 / 酒精
2. Shake the test tube 摇晃试管
3. Add the water 加水

If the contents become cloudy / milky, then the lipid is present.

![image-20250925112811236](./Chapter-2.assets/image-20250925112811236.png)
...
酒精会先使油**均匀地**溶解在液体中，后来再加的水会让非常小的“油脂滴”存在于水中，形成一种“雾蒙蒙”的效果。

![image-20250925114020144](./Chapter-2.assets/image-20250925114020144.png)
...
>
> **如果反过来先加水：**
> 脂质根本不溶于水，所以加水后脂质会聚集成一大团，无法分散。这时再加入酒精，虽然酒精能溶解脂质，但很难将已经聚集在一起的脂质团块完全、均匀地溶解开。因此，最后溶液可能只会变得有些浑浊，或者乳化现象非常不明显，导致实验失败或结果难以观察。
...
![image-20250925115701235](./Chapter-2.assets/image-20250925115701235.png)
...
The R group is the **side chain** that makes each amino acid unique. There are 20 main types, with different chemical properties:
R基是氨基酸的**侧链**（位于氨基酸的边上），它决定了每种氨基酸的唯一性。主要有20种类型，具有不同的化学性质：
...
The chemical nature of the R groups determines how the protein folds and functions.
R基的化学性质决定了蛋白质如何折叠并执行其功能。

![image-20250925120007968](./Chapter-2.assets/image-20250925120007968.png)

总共有20种不同的R group，因为这些R group的不同，所以有20中氨基酸。

> 例如最简单的R group只由一个`H`（氢原子）构成，这种氨基酸被称为Glycine

不同的R group可以在课本的第608页附录中找到：

![image-20250925120224325](./Chapter-2.assets/image-20250925120224325.png)

对于考试来说，必须要会分辨Cysteine和Glycine：

- 只含有一个`H`氢原子，则是Glycine

- 含有`S`硫原子，则是Cysteine

#### Polar and Non-polar Amino acids

![image-20250925121149348](./Chapter-2.assets/image-20250925121149348-1758773511596-1.png)

![image-20250925121230959](./Chapter-2.assets/image-20250925121230959.png)

![image-20250925121255644](./Chapter-2.assets/image-20250925121255644.png)

- Charged side - hydrophilic (溶于水)

  如果R group的一端标有`+`或`-`，说明这个部分是被电离了的。

- Polar side - hydrophilic (溶于水)

  如果R group的一端有`OH`或`NH₂`，那么这个是极性的
...
![image-20250926090527087](./Chapter-2.assets/image-20250926090527087.png)

两个氨基酸会通过Condensation连接到一起，并产生一个**peptide bond**，peptide bond在上图右侧标出来了，它包括四个原子（四个元素）：`C`, `O`, `N`, `H`。

两个氨基酸通过这个condensation连接到一起时会形成Dipeptide，而很多个氨基酸通过同样的方式连接到一起时会形成Polypeptide↓。

![image-20250926090617935](./Chapter-2.assets/image-20250926090617935.png)

### 4 Levels of Protein Structure

![image-20250926090707516](./Chapter-2.assets/image-20250926090707516.png)
...
- Held by **hydrogen bonds**
  ...
  主要由主链上的**C=O**与**N-H** group之间形成的**氢键**来稳定。
...
>
> <img src="./Chapter-2.assets/image-20251003105933824.png" alt="image-20251003105933824" style="zoom:80%;" />
>
> 图中的虚线代表`hydrogen bond`

#### Tertiary Structure

一条蛋白质链<u>在α-helix或β-pleated sheet的基础上</u>形成的三维结构被称为三级结构。一条蛋白质链最多只能形成三级结构，如果要组成四级结构需要更多的蛋白质链加入。

- **Folding and Coiling** of a polypeptide chain (secondary structures → 3D shape)

  指**一条**多肽链在二级结构基础上进一步**折叠和盘绕**形成的完整三维空间结构。
...
- Formed by four types of bonds:
  ...
  > <img src="./Chapter-2.assets/image-20250926091753072.png" alt="image-20250926091753072" style="zoom:67%;" />
  >
  ...
  > <img src="./Chapter-2.assets/image-20250926091809445-1758849489755-1.png" alt="image-20250926091809445" style="zoom:67%;" />
  >
  ...
  > <img src="./Chapter-2.assets/image-20250926091827282.png" alt="image-20250926091827282" style="zoom: 67%;" />
  >
  > The ionic bond will be broken when the pH changes
  1. weak hydrophobic interactions

  > <img src="./Chapter-2.assets/image-20250926091845798.png" alt="image-20250926091845798" style="zoom: 67%;" />
  >
...
- Made by two or more ploypeptide chains (may also contains other structures)
  ...
  由**两条或两条以上**具有独立三级结构的polypeptide构成（有时候还会包括非peptide的成分，比如血红蛋白中的血红素）
...
球状蛋白是**可溶的**，它疏水的部分（non-polar hydrophobic R group）集中的蛋白质的中心位置，不会影响到周围的水分子；同理，它亲水的部分（hydrophilic R
group）在蛋白质的外层，使整个分子是出于亲水的状态。

> 关于可溶性的相关内容可以回顾上面的[hydrogen bond](#Hydrogen Bond)部分。

<img src="./Chapter-2.assets/image-20251003111516131.png" alt="image-20251003111516131" style="zoom:50%;" />
...
血红蛋白中有四条链 → 每条链中有一个血红素 → 每个血红素中有一个铁原子 → 每一个铁原子都可以和一个氧分子`O₂`“可逆地”结合（铁和氧既可以连接在一起也可以分开）

> 所以说一个血红蛋白可以携带四个氧分子（总共8个氧原子）
>
> <img src="./Chapter-2.assets/image-20251005171122777.png" alt="image-20251005171122777" style="zoom:80%;" />
>
...
- [x] 含有氧气：亮红色 **Bright red** (含有氧气的血红素又被叫做**oxyhaemoglobin**)
- [ ] 没有氧气：暗红色 **Bluish red**

> #### Sickle Cell Anaemia 镰刀状细胞贫血
>
> <img src="./Chapter-2.assets/image-20251005171513219.png" alt="image-20251005171513219" style="zoom:50%;" /><img src="./Chapter-2.assets/image-20251005171528375.png" alt="image-20251005171528375" style="zoom:50%;" />
>
> 镰刀状细胞贫血是一种遗传性血液疾病，其根本原因在于**基因突变**导致血红蛋白**分子结构异常**。这种异常的血红蛋白在缺氧状态下会使正常的圆盘形红细胞变形为僵硬的“镰刀状”，从而引发一系列健康问题。
>
...
![image-20251005221636362](./Chapter-2.assets/image-20251005221636362.png)
...
![image-20251005222402288](./Chapter-2.assets/image-20251005222402288.png)

> #### The Structure of Collagen Molecule and Fibre
>
> | **Collagen Molecule**               | **Collagen Fibre**                             |
> | ----------------------------------- | ---------------------------------------------- |
> | Triple helix                        | cross links / covalent bonds between molecules |
> | tightly wound                       | molecules arranged in parallel                 |
> | hydrogen bonds between polypeptides | the ends are not aligned                       |
> | every third amino acid is glycine   | made from collagen molecules                   |
...
1. Add 2cm³ of biuret solution to 2cm³ of sample
2. Deduce the result:
   - Blue: Positive result, protein present
   - Purple: Negative result, no protein

![image-20251005222743836](./Chapter-2.assets/image-20251005222743836.png)
...
| :----------------------------------------- | :--------------------------- | :--------------------------------------------------------------------------------------------------------------------- |
| collagen 胶原蛋白<br>keratin 角蛋白        | structural 结构蛋白          | **胶原蛋白**：存在于皮肤、肌腱、骨骼中，提供支撑和弹性。<br>**角蛋白**：构成头发、指甲、羽毛和角，提供保护和硬度。     |
| amylase 淀粉酶, <br>lactase 乳糖酶         | enzyme 酶                    | **淀粉酶**：在唾液和胰液中，催化淀粉分解为糖。<br>**乳糖酶**：在小肠中，催化乳糖分解为葡萄糖和半乳糖。                 |
| insulin 胰岛素                             | hormone 激素                 | 由胰腺分泌，调节血糖水平。缺乏会导致糖尿病。                                                                           |
| haemoglobin 血红蛋白<br>myoglobin 肌红蛋白 | respiratory pigment 呼吸色素 | **血红蛋白**：在红细胞中，负责运输氧气。<br>**肌红蛋白**：在肌肉细胞中，储存氧气以备肌肉收缩时使用。                   |
| antibodies 抗体<br>fibrinogen 纤维蛋白原   | defence 防御                 | **抗体**：识别并中和外来病原体，如病毒和细菌。<br>**纤维蛋白原**：在受伤时转化为纤维蛋白，形成血凝块阻止出血。         |
| actin 肌动蛋白<br>myosin 肌球蛋白          | contraction 收缩             | 二者是肌肉纤维的主要成分，通过相互滑动引起肌肉收缩。                                                                   |
| casein 酪蛋白<br>ovalbumin 卵清蛋白        | storage 储存                 | **酪蛋白**：牛奶中的主要蛋白质，为哺乳动物幼崽提供氨基酸。<br>**卵清蛋白**：鸡蛋清中的主要蛋白质，为胚胎发育提供营养。 |

### Summary

> **Key Concept:** Biological molecules are built through <u>condensation reactions</u> (removing water) and broken down through <u>hydrolysis</u> (adding water).
>
> 生物分子通过condensation连接在一起，通过hydrolysis分开

The larger biological molecules are made from smaller molecules. The smaller molecules are joined together by **<u>condensation reactions</u>**. Condensation involves **removal of water**. The reverse process, **adding water**, is called **<u>hydrolysis</u>** and is used to break the large molecules back down into smaller molecules. **Polysaccharides** are made from **monosaccharides**, **proteins (polypeptides)** from **amino acids**, **lipids** from **fatty acids and glycerol**. Polysaccharides and proteins are formed from repeating identical or similar subunits called **monomers**. They are, therefore, **polymers**. These build up into giant molecules called **macromolecules**.

> Carbohydrates follow the general formula Cₓ(H₂O)ᵧ - hence the name "hydrates of carbon."

**Carbohydrates** have the general formula Cₓ(H₂O)ᵧ and include **monosaccharides**, **disaccharides** and **polysaccharides**. Monosaccharides are joined together by **<u>glycosidic bonds</u>** to make disaccharides and polysaccharides. Monosaccharides (e.g. *glucose*) and disaccharides (e.g. *sucrose*) are very water-soluble and are known as **sugars**. They are important **energy sources** in cells and also important **building blocks** for larger molecules like polysaccharides.
...
**Benedict's reagent** can be used to test for **<u>reducing and non-reducing sugars</u>**. The test is **semi-quantitative**.
...
**'Iodine solution'** can be used to test for **<u>starch</u>**.

**Glycogen** is an **energy storage** compound in *animals*. It is made from **α-glucose**. Its structure is similar to that of amylopectin but with **<u>more branching</u>**. **Cellulose** is a polymer of **β-glucose** molecules. The molecules are grouped together by **<u>hydrogen bonding</u>** to form mechanically strong fibres with **high tensile strength** that are found in **plant cell walls**.

> Fats (solid at room temperature) vs Oils (liquid at room temperature) - both are triglycerides.

**Lipids** are a diverse group of chemicals, the most common of which are **triglycerides** (fats and oils). Triglycerides are made by condensation between **three fatty acid molecules and glycerol**. **<u>Ester bonds</u>** join the fatty acids to the glycerol. Triglycerides are **hydrophobic** and do not mix with water. They act as **energy storage compounds**, as well as having other functions such as *insulation and buoyancy* in marine mammals.
...
The **emulsion test** can be used to test for **<u>lipids</u>**.

**Proteins** are long chains of **amino acids** which fold into precise shapes. Amino acids are joined together by **<u>peptide bonds</u>**.
...
Proteins have up to **four levels of structure** known as **<u>primary, secondary, tertiary and quaternary structures</u>**. The **primary structure** is the *sequence of amino acids* in a protein. This largely determines the way that it folds and hence its **three-dimensional shape and function**.

**Secondary structure** is a result of **<u>hydrogen bonding</u>** between the amino acids. Examples of secondary structure are the **α-helix** and the **β-pleated sheet**. Further folding of proteins produces the **tertiary structure**. Often, a protein is made from more than one polypeptide chain. The association between the different chains is the **quaternary structure** of the protein. Tertiary and quaternary structures are very precise and are held in place by **hydrogen bonds, disulfide bonds (which are covalent), ionic bonds and hydrophobic interactions**.
...
**Biuret reagent** can be used to test for **<u>proteins</u>**.
...
- **酶亲和力的比较** (Comparing Enzyme Affinity)
  - 米氏常数 ($K_m $ at$v = \frac{1}{2} V\_{\max}$)
...
- Many enzyme names end in `–ase` (e.g. amylase and ATPase)

Enzyme acts as a biological catalyst in a chemical reaction by **reducing activation energy**. 酶通过**降低活化能**来加速反应。

> 所有反应都要获得一定能量来让不同的反应物之间发生反应，这个能量被称为“活化能”（activation energy / $A_E$）。
>
> 酶能够降低这个能量，所以说现在反应物只需要更少的能量便可以发生反应了。

| Enzyme   | Substrate | Products            | Chemical Equation                                    |
| -------- | --------- | ------------------- | ---------------------------------------------------- |
| Amylase  | Starch    | Maltose             | $\ce{starch + H2O ->[amylase] maltose}$              |
| ATPase   | ATP       | ADP + Pᵢ            | $\ce{ATP + H2O ->[ATPase] ADP + P_i}$                |
| Protease | Protein   | Amino acids         | $\ce{protein + H2O ->[protease] amino acids}$        |
| Maltase  | Maltose   | Glucose             | $\ce{maltose + H2O ->[maltase] glucose}$             |
| Lactase  | Lactose   | Glucose + Galactose | $\ce{lactose + H2O ->[lactase] glucose + galactose}$ |
| Nuclease | RNA/DNA   | Nucleotides         | $\ce{RNA/DNA + H2O ->[nuclease] nucleotides}$        |
...
- **Intracellular** - 在**细胞内**发生催化反应
- **Extracellular** - 在**细胞外**发生催化反应

Digestive enzymes in the gut are extracellular enzymes. Some organisms secrete enzymes outside their bodies. Fungi, for example, often do this in order to digest the food on which they are growing.
胆囊中产生的消化酶就属于在细胞外作用的酶（细胞外酶），它们被分泌到消化道中消化食物。还有些生物（比如真菌）会直接将消化酶分泌到它们要消化的食物上。
...
酶的表面有一个称为**活性位点**的凹陷。酶作用的反应物称为**底物**，底物与酶的活性位点结合。当它们结合在一起时，形成**酶-底物复合物**。

![image-20251009112702539](./Chapter-3.assets/image-20251009112702539.png)

$$
\ce{Enzyme + Substrate -> Enzyme-Substrate Complex}\
$$
...
一种enzyme只会针对于一个**特定的**substract产生作用，这是因为enzyme的active site只和一种substrate的形状契合。可以用以下词语来描述：
...
- As the substrate enters the active site, the active site **induces** and <u>changes the shape slightly</u>.
...
> **关键点**：现代研究支持**诱导契合假说**，认为酶是**柔性**的，结合时会发生**构象变化**，从而更高效地催化反应。
...
是一个enzyme反应速率最高的温度或pH被称为“最佳温度”或“最佳pH”（*optimum temperature*和*optimum pH*），不同的酶有不同的最佳温度和最佳pH，这取决于它们工作的环境。

![image-20251014140025552](./Chapter-3.assets/image-20251014140025552.png)

#### Describe the Graph

![image-20251014131506946](./Chapter-3.assets/image-20251014131506946.png)

- As the time increases, the total volume of $\ce{O2}$ **(Dependent variable) increases**
- As the time increases, the **reaction rate decreases**
- Address actual data to support

> 描述图像的时候，需要提到**因变量**和**反应速率**怎么<u>根据时间发生改变</u>，并且提到<u>具体的数据</u>来支持。
>
> As the `factor on the x-axis` increases, the `factor on the y-axis` increases / decreases.
...
- the frequency of <u>successful collision</u> **decreases**
...
![image-20251014132649318](./Chapter-3.assets/image-20251014132649318.png)
...
>
> - 先提到这个变量是一个**limiting factor**
> - 描述**successful collision**会怎么变化（increase / decrease）
> - 描述**enzyme-substrate complexes**会怎么变化（increase / decrease）
...
当这些tertiary structure中的键发生断裂时，enzyme的<u>形状会发生改变</u>，从而导致<u>active site的形状会发生改变</u>，使得substrate和enzyme无法组合到一起发生反应。

#### Temperature's Effect

![image-20251014134123416](./Chapter-3.assets/image-20251014134123416.png)
...
![image-20251014135056599](./Chapter-3.assets/image-20251014135056599.png)

![image-20251014135113829](./Chapter-3.assets/image-20251014135113829.png)
...
1. **测量产物生成速率**（如：过氧化氢酶实验）
   - 反应：\(\ce{H2O2 ->[catalase] H2O + O2}\)
   - 方法：收集氧气，测量单位时间内的体积变化。
2. **测量底物消耗速率**（如：淀粉酶实验）
   - 反应：\(\ce{starch ->[amylase] maltose}\)
   - 方法：定时取样，用**碘液测试**或**本尼迪克特测试**，结合**比色计**测量颜色变化。

#### Using a Colorimeter 使用比色计

- **原理**：测量溶液对特定波长光的**吸光度**或**透光率**。
- **步骤**：
  1. **校准**：使用空白溶液（如蒸馏水）将仪器调零。
  2. **测量**：将样品放入比色皿，读取吸光度值。
  3. **绘制标准曲线**：用已知浓度的溶液绘制浓度 vs 吸光度曲线，用于推算未知样品浓度。

> **实验技巧**：测量前**必须校准**，否则数据无效。使用**红色滤光片**可提高淀粉-碘复合物的测量灵敏度。
...
- **定义**：反应速率达到最大速率一半（\(\frac{1}{2}V\_{\max}\)）时的底物浓度。
- **意义**：\(K_m \) 值**越小**，酶对底物的**亲和力越高**（所需底物浓度越低）。
- **公式**：\(K*m = [S] \text{ at } v = \frac{1}{2}V*{\max}\)
- **与 \(V\_{\max}\) 的关系**：两者相互独立。\(V\_{\max}\) 反映酶的最大催化能力，\(K_m\) 反映酶对底物的亲和力。
...
| 类型               | 结合部位                    | 对 \(V\_{\max}\) 的影响 | 对 \(K_m \) 的影响 | 能否通过增加底物浓度逆转 |
| :----------------- | :-------------------------- | :---------------------- | :----------------- | :----------------------- |
...
- **类型**：一种**可逆的非竞争性抑制**。
- **机制**：代谢途径的**终产物**作为抑制剂，结合到途径中的**第一个酶**的变构部位，从而**负反馈调节**整个途径，防止产物过度积累。
- **意义**：维持细胞内代谢物的**稳定浓度**，是生物体**自我调节**的重要方式。
...
1. **可重复使用**：酶被固定后可以**多次回收利用**，降低成本。
2. **产物纯度高**：酶不混入产物，**无需后续分离**。
3. **稳定性增强**：对温度、pH 变化的耐受性**高于游离酶**。
4. **避免终产物抑制**：酶与产物可快速分离，减少抑制作用。
5. **适合连续化生产**：可填充于反应柱，实现**连续流动反应**。
...
> **意义**：为**乳糖不耐受人群**提供可饮用的牛奶，同时保留牛奶的营养价值。
...
1. **浓度**：使用**比例稀释**或**系列稀释**法配制不同浓度溶液。
2. **体积**：使用**量筒**或**移液器**精确量取。
3. **温度**：使用**恒温水浴锅**精确控制。
4. **pH**：使用**缓冲溶液**维持特定 pH。

> **实验关键**：每次实验**只能改变一个自变量**，其他所有条件必须严格保持一致，才能得出可靠结论。

---

### 复习要点总结

- **酶是蛋白质催化剂**，通过**降低活化能**和**诱导契合**机制工作。
- **反应速率**受**酶浓度、底物浓度、温度、pH、抑制剂**影响。
- **\(K_m\) 反映亲和力**，低 \(K_m\) = 高亲和力。
- **竞争性抑制**可通过增加底物逆转，**非竞争性抑制**则不能。
- **固定化酶**具有**可重复使用、稳定性高、易于分离**等优点，广泛应用于工业和食品加工。
- **实验设计**必须明确**自变量、因变量、控制变量**，并掌握**稀释、温控、pH 控制**等基本实验技能。

### SUMMARY

Enzymes are globular proteins which catalyse metabolic reactions. Each enzyme has an active site with a <u>flexible structure</u> which can change shape slightly to fit precisely the substrate molecule. This is called the ***induced-fit hypothesis***.
...
- Each enzyme has an ***optimum temperature*** at which it works fastest. As temperature increases above the optimum temperature, the enzyme gradually <u>denatures</u> (loses its precise tertiary structure).
...
The efficiency of an enzyme can be measured by finding the value known as the **Michaelis–Menten constant, \(K_m\)**. To do this, the **maximum rate of reaction, \( V\_{max} \)**, must first be determined. Determination of \( V\_{max} \) involves finding the initial rates of reactions at different substrate concentrations while *ensuring that enzyme concentration remains constant*.

---

Enzymes are affected by the presence of <u>inhibitors</u>, which slow down or stop their activity. ***Competitive inhibitors*** have a *similar shape* to the normal substrate molecules. They **compete with the substrate** for the active site of the enzyme. Competitive inhibition is *reversible* because the inhibitor can enter and leave the active site.
...
Enzymes can be <u>immobilised</u> – for example, by trapping them in jelly (alginate) beads. This is **commercially useful** because the enzyme can be *re-used* and the product is *separate from (uncontaminated by) the enzyme*. Immobilisation often makes enzymes **more stable**.
...
![image-20251023111930701](./Chapter-4.assets/image-20251023111930701.png)

在这张图片中可以看到细胞膜上有很多微小的结构：

![image-20251023112206498](./Chapter-4.assets/image-20251023112206498.png)
...
![image-20251024092427668](./Chapter-4.assets/image-20251024092427668.png)

![image-20251027201834907](./Chapter-4.assets/image-20251027201834907.png)
...
- Down the concentration gradient
- Passive, <u>don't require extra energy</u>
- Use transport protein (**specific** to a particular ion / molecule, only allow a certain type of particle to move through)
  ...
  >
  > **Carrier protein** can <u>change their shape</u> to transport the molecules such as sugars and amino acids. 就算Carrier protein会改变形状，它也没有用ATP

- Across a cell membrane

在facilitated diffusion中，transport protein是**可以改变或不改变**自身形状的：
...
>
> ![image-20251030115637204](./Chapter-4.assets/image-20251030115637204.png)
>
...
> ![image-20251030120144868](./Chapter-4.assets/image-20251030120144868.png)
>
> | 试管           | 左试管（S）     | 右试管（I）     |
> | -------------- | --------------- | --------------- |
...
| Very Low<br>(More Concentrated Solution) | Moves out of the cells | Shrink      | Plasmolysed |
...
> 质壁分离发生的那一个点。
>
> <img src="./Chapter-4.assets/image-20251107193236339.png" alt="image-20251107193236339" style="zoom: 67%;" />
...
![image-20251103115433717](./Chapter-4.assets/image-20251103115433717.png)
...
![image-20251103115733754](./Chapter-4.assets/image-20251103115733754.png)
...
![image-20251103120040335](./Chapter-4.assets/image-20251103120040335.png)

Bulk transport forms **vesicles** to transport the materials, instead of carrier proteins in active transport.

![image-20251103120800692](./Chapter-4.assets/image-20251103120800692.png)
...
- **Phospholipid bilayers are a barrier** to most water-soluble substances because the interior of the membrane is <u>hydrophobic</u>.
- **Cholesterol** is also needed for membrane *fluidity* and *stability*.
- Some proteins are **transport proteins**, transporting molecules or ions across the membrane. They may be either ***channel proteins*** or ***carrier proteins***. Channel proteins have a <u>fixed shape</u>; carrier proteins <u>change shape</u>. Some proteins act as *enzymes*.
- **Glycolipids and glycoproteins** form <u>receptors</u> – for example, for hormones or neurotransmitters. They also form **cell–cell recognition markers**.
...
The **cell surface membrane** controls <u>exchange</u> between the cell and its environment. Some chemical reactions take place on membranes inside cell organelles, as in *photosynthesis* and *respiration*.
...
Water moves from regions of <u>higher water potential</u> to regions of <u>lower water potential</u>. When this movement occurs through a **partially permeable membrane**, such as the cell surface membrane, this diffusion is called ***osmosis***.

Adding solute *lowers the water potential*. Adding pressure to a solution *increases the water potential*.

In dilute solutions, <u>animal cells burst</u> as water moves into the cytoplasm. In dilute solutions, a <u>plant cell does not burst</u>, because the **cell wall** provides resistance. In concentrated solutions, animal cells <u>shrink</u>, while in plant cells the **protoplast shrinks away from the cell wall** in a process known as ***plasmolysis***.
...
- **Replace** damaged / dead cells 替换死去的细胞
  ...
  > 描述**tissues**时用**repair**，描述**cells**时用**replace**
...
> [!NOTE]
>
> What is the role of mitosis in repairing damaged tissues?
>
...
<img src="./Chapter-5.assets/image-20251110110640522.png" alt="image-20251110110640522" style="zoom:67%;" />

1. Interphase 分裂间期 - The growth of a cell 细胞先会自己成长
   - **$ G_1 $phase**
   - **$ S $ phase**
   - **$ G_2 $ phase**
2. $ M $ phase / Mitosis / Nuclear division 有丝分裂期
   1. **Prophase 前期**
   2. **Metaphase 中期**
   3. **Anaphase 后期**
   4. **Telophase 末期**
...
Cells make the <u>RNA, enzyme and other proteins</u> needed for growth. At the end of this phase, the cell becomes committed to dividing or not dividing. If the cell doesn't need to divide, then the phase will stop here. 制造分裂所需的物质
...
The cell continues to grow and the new DNA that was made during the **$ S $ phase** is checked, Any errors are usually repaired. 检查并消除潜在的错误。
...
![image-20260108085536983](./Chapter-5.assets/image-20260108085536983.png)
...
![image-20260108085606107](./Chapter-5.assets/image-20260108085606107.png)
...
![image-20260108085733932](./Chapter-5.assets/image-20260108085733932.png)
...
![image-20260108085749852](./Chapter-5.assets/image-20260108085749852.png)
...
During $ S $ phase, the DNA replicates to create two identical strands of DNA called **chromatids**, joined together by a narrow region called the **centromere**.

DNA先被打包成紧凑的chromatin存放在细胞核中；在细胞分裂时，DNA会被打包成两个一样的chromatid，两个chromatid通过centromere连接在一起，形成chromosome。

![image-20251111135448130](./Chapter-5.assets/image-20251111135448130.png)
...
<img src="./Chapter-5.assets/image-20251111132345440.png" alt="image-20251111132345440" style="zoom:50%;" />
...
**Telomerase** can <u>add bases to telomere</u> to prevent telomeres fron getting shorter. But it's NOT active in most human body cells.

> In the zygote, telomerase is active so it can maintain a long telomere at the end of chromosome.

#### Chromatid - 染色单体

<img src="./Chapter-5.assets/image-20251110120844294.png" alt="image-20251110120844294" style="zoom:67%;" />
...
- **Totipotent stem cells** - these stem cells can differentiate into <u>any cell type</u> (inclluding any cells that make up the embryo or placenta)
- **Pluripotent embryonic stem cells** - these stem cells can differentiate into any cell type in the developing embryo <u>but not into cells that make up the placenta</u>.
- **Multipotent adult stem cells** - these stem cells can differentiate into <u>a limited range of cell types</u>.
...
![image-20251111134541828](./Chapter-5.assets/image-20251111134541828.png)
...
1. Cancers start when random mutations in genes controlling cell division **initiate uncontrolled mitosis**.

2. For example, proto-oncogene 原癌基因 is **mutated to oncogenes** 致癌基因, tumour suppressor gene is mutated and switched off.

   > **Proto-oncogene** is the normal cell, but if it mutates to oncogene, is becomes cancerous cell.
   >
   > 原癌基因所指的是**正常的细胞**

3. Cancerous cells **don't enter programmed cell death**, don't respond to signals of controlling mitosis to stop dividing and have shorter interphase and rapid DNA replication. There is no contact inhibition. They lose specialisation. Cells do not function.
...
**Chromosomes** are made of ***chromatin***. Chromatin consists mainly of <u>DNA wrapped around basic protein molecules called histones</u>.

During nuclear division, chromosomes become visible and are seen to consist of **two chromatids** held together by a ***centromere***. Each chromatid contains <u>one DNA molecule</u>.

**Growth** of a multicellular organism is a result of *cells dividing to produce genetically identical daughter cells*.

During **cell division**, the *nucleus divides first*, followed by division of the whole cell. Division of a nucleus to produce two genetically identical nuclei is achieved by the process of ***mitosis***. Mitosis is divided into <u>four phases</u>: **prophase, metaphase, anaphase and telophase**.

Mitosis is used in **growth, repair, asexual reproduction** and <u>cloning of cells during an immune response</u>.

The period from one cell division to the next is called the ***cell cycle***. It has <u>four phases</u>: **\( G_1 \)** is the *first growth phase* after cell division; **\( S \) phase** is when the <u>DNA replicates</u>; **\( G_2 \)** is a *second growth phase*; **\( M \) phase** is when <u>nuclear division</u> takes place (followed by cell division).
...
Many *specialised cells lose the ability to divide*, but certain cells known as ***stem cells*** retain this ability. Stem cells are <u>essential for growth from zygote to adult and for cell replacement and tissue repair</u> in the adult.
...
**Cancers** are *tumours resulting from repeated and uncontrolled mitosis*. They are thought to start as the result of <u>mutation</u>.
...
![image-20251120121538417](./Chapter-6.assets/image-20251120121538417.png)
...
>
> T和U的结构非常相似，他们之间的区别就在于T比U多一个$CH_3$的部分。
>
> ![image-20251121092305854](./Chapter-6.assets/image-20251121092305854.png)
...
- 右下角**含有**氧原子的 - ribose
- 右下角**没有**氧原子的 - Deoxyribose

![image-20251121090646805](./Chapter-6.assets/image-20251121090646805.png)
...
![image-20251124111429249](./Chapter-6.assets/image-20251124111429249.png)

> Hydrolysis of ATP:
>
> 1. add water
> 2. water molecule can break down the bond between phosphate groups
> 3. the energy is released
>
> $$
> \ce{ATP -> ADP + P_i}
> $$
>
> $P_i$ is a single phosphate molecule: $H_3PO_4$
...
![image-20251120185415330](./Chapter-6.assets/image-20251120185415330.png)

#### Purines and Pyrimidines

**Purines** and **pyrimidines** are two different types of structure that formed by the **nitrogenous base** molecules:

1. Pyrimidines (**single**-ring structure) - **cytosine**, **thymine**, **uracil**

2. Purines (**double**-ring structure) - **adenine** and **guanine**

> 记忆口诀：
>
> 1. Y 的读音像one，所以p**y**rimidines是一个环的结构
> 2. Purines - **P**ure **A**s **G**lod”，然后剩下的都是pyrimidine
> 3. **A** 和 **G** 是特殊的，所以它们有**两个环**，其他的三个都只有一个环

<img src="./Chapter-6.assets/image-20251120190237658.png" alt="image-20251120190237658" style="zoom:50%;" />
...
- `A` pairs with `T`/`U` by **2 hydrogen bonds**
...
![image-20251124113959563](./Chapter-6.assets/image-20251124113959563.png)

> 这个左边DNA single strand的顺序是`5'`到`3'`的，而另一边正好相反，所以说DNA两边是：**antiparallel strands** 相反平行链。
>
> `5'`到`3'`表示的是：从pentose最右边的碳原子按顺时针的方向开始算，第三个或第三个碳原子与下一个nucleotide相连。

DNA两侧的结构叫做**sugar-phosphate backbone**, sugar和phosphate之间的bond叫做**phosphodiester bond** (<u>phospho</u> - <u>di - ester</u>)
...
1. mRNA, messenger RNA - encodes protein, it can move out the nucleus and go into the cytoplasm
2. tRNA, transfer RNA - carries amino acid
3. rRNA, ribosomal RNA - forms the sibosome
...
![image-20251124110220081](./Chapter-6.assets/image-20251124110220081.png)
...
- **Helicase** - **Unwind** DNA double helix and break $H$ bonds between base pairs to seperate DNA strands
- **DNA Polymerase**
...
![image-20251125185723950](./Chapter-6.assets/image-20251125185723950.png)

**Semi-conservative** DNA replication:

1. DNA double helix **unwinds** and hydrogen bonds between base pairs break by **helicase**.
2. Both strands are used as templates
3. Alone each template, **DNA polymerase** catalyses the formation of a new **complementary** DNA strand in a **`5'` to `3'` direction.**
4. **DNA polymerase** adds complementary, activated nucleotides **step by step**, following complementary base pairing
5. Process **continues** along whole DNA molecule.
6. DNA polymerase catalyses the formation of **phosphodiester bond** between nucleotides and has a **proofreading ability**.
7. The new strand growing continuously is called **leading strand**, The other new strand which cannot be made in a continuous way is called **lagging strand**. Those short fragments are called **Okazaki fragments**.
8. **DNA ligase joins Okazaki fragments on laggin strand**, it catalyses the formation of phosphodiester bonds, between the fragments
9. Replication is **semi-conservative**. *Each new DNA molecule is made of one old strand and one new strand.*

> DNA的**半保留复制**过程如下：
>
> 1. **起始与解旋**：首先，DNA双螺旋结构在**解旋酶**的作用下被解开，双链之间的氢键断裂，形成一个称为"复制叉"的Y形结构。
> 2. **模板准备**：解开的两条母链现在都作为合成新链的**模板**。
> 3. **链的合成**：**DNA聚合酶**开始工作，根据**碱基互补配对**原则（A配T，G配C），将新的核苷酸添加到生长中的链上。新链的合成**方向永远是5'到3'**。
> 4. **两条链的不同合成方式**：
>     - **前导链**：它的合成方向与复制叉移动的方向一致，因此可以**连续地**被合成。
>     - **后随链**：它的合成方向与复制叉移动的方向相反，因此只能**不连续地**合成，形成一系列短的**冈崎片段**。
> 5. **校对与连接**：
>     - DNA聚合酶在合成过程中具有**校对**功能，可以及时发现并纠正错误，保证复制的准确性。
>     - 在后随链上，**DNA连接酶**会像"胶水"一样，将所有的**冈崎片段**连接起来，形成一条完整的DNA链。
> 6. **完成**：复制完成后，得到两个完全相同的DNA分子。每个新DNA分子都包含一条旧的母链和一条全新的子链，这完美地诠释了**半保留复制**的含义。
...
1. Grow E.coli with **nitrogen-15** for many generations - *Result: All DNA is heavy*
2. Transfer to a medium with **nitrogen-14** and allow E.coli to divide to produce 1 generation

   **\*Result**: All DNA is a Hybrid of **1 heavy strand** and **1 light strand\***

3. Repeat for 2 more generations and observe DNA
...
1. A part of DNA molecule **unwinds**, this exposes the **gene** to be transcribed
2. A complementary copy of code is formed (mRNA)
   - The DNA triples of bases are transcribed as mRNA codons
   - 单链的mRNA可以通过细胞核上的小孔，但是双链的DNA不行

![image-20260209080325826](./Chapter-6.assets/image-20260209080325826.png)

#### Translation

Translation发生的过程：

1. mRNA's two codons at a time are exposed to the larger subnuit (in ribosome)
2. A specific tRNA brings a specific amino acid (corresponding to the codon on mRNA)
3. Complementary base pairing occurs by hydrogen bonding
4. A second tRNA brings another aminoacid next to the first amino acid
5. Peptide bond formation between the two amino acids
6. Ribosome moves along the mRNA, one codon at a time (above process is repeated until a stop codon is reached)
7. The first tRNA leaves the ribosome
...
<img src="./Chapter-7.assets/image-20251217123347521.png" alt="image-20251217123347521" style="zoom:33%;" />

![image-20260209105043008](./Chapter-7.assets/image-20260209105043008.png)
...
1. Soil
2. Epidermis in root and Cortex in root
3. Endodermis in root
4. Pericycle in root
5. Move in xylem in root, stem and leaf
6. Mesophyll cells in leaves
7. Air spaces in leaves
8. Stomata
...
1. Transpiration and evaporation of water lower the water potential at leaves, creating tension (a negative pressure) in the xylem.
2. Tension pulls water and minerals up the xylem by mass flow from root to stem the to leaf, as a continuous, unbroken column of water due to cohesion, adhesion and the narrow diameter of xylem vessels. This pulling effect is known as transpirational pull.
3. Leaves have a lower water potential and roots have a higher water potential. There is a water potential gradient between them.
4. Tension pulls xylem walls inwards. During the daytime, when stomata open, the diameter of a tree trunk decreases.
5. As tension increases in the xylem, the pressure becomes more negative.
...
1. **Apoplast pathway** 通过细胞壁之间的间隙传输
...
```mermaid
sequenceDiagram
    participant Soil as Soil Solution
    participant Cortex as Root Cortex
    participant Endo as Endodermis Cell
    participant Xylem as Xylem Vessel

    Note over Soil,Cortex: Water & Minerals Arrive

    Cortex->>Endo: Apoplast Pathway (Cell Walls)
    Cortex->>Endo: Symplast Pathway (Cytoplasm)

    Note over Endo: Casparian Strip Blocks<br/>Apoplast Pathway

    Endo->>Endo: Water Forced into Symplast
    Endo->>Endo: Selective Mineral Uptake<br/>via Active Transport

    Endo->>Xylem: Water Enters Xylem
    Endo->>Xylem: Controlled Mineral Entry

    Note over Endo,Xylem: Plants Control What<br/>Enters Vascular System
```

#### How the structure of xylem vessles is suited to their function
...
1. Assimilate - organic compounds made by the plant itself.

2. Source - a site in plant which produces and provides assimilates.

3. Sink - a site in plant which needs, receives or stores assimilates for growth of for storage.
...
1. Active loading at the source
   ...
   - Result in...
     ...
     > [!IMPORTANT]
     >
     > 1. **increment of the sucrose's concentration**
     > 2. **decrement in the water potential** in phloem sieve tubes
     > 3. increment in volume of sap in phloem sieve tubes

2. Hydrostatic pressure changes
...
1. **Hydrogen ions (protons, H⁺)** are pumped out of the companion cell into the cell wall by a **proton pump** using ATP via **active transport**.
2. This creates a **higher concentration of H⁺ ions** in the cell wall.
3. The hydrogen ions move back into the companion cell by **passive facilitated diffusion** down their concentration gradient, through a **co-transporter protein** (a type of carrier protein).
4. The co-transporter protein **simultaneously transports sucrose molecules** into the companion cell, even **against** the sucrose concentration gradient.
5. Sucrose molecules then **diffuse through plasmodesmata** from the companion cell into the **sieve tube element**.

```mermaid
sequenceDiagram
    participant ATP as ATP Energy
    participant CC as Companion Cell
    participant Wall as Cell Wall Space
    participant ST as Sieve Tube Element

    ATP->>CC: Provides Energy
    CC->>Wall: Proton Pump<br/>Active Transport H⁺ Out
    Note over CC,Wall: ATP-driven<br/>Creates H⁺ Gradient

    Wall->>CC: H⁺ Diffuses Back In
    Note over Wall,CC: Down Concentration Gradient

    CC->>CC: Co-transporter Protein<br/>Brings Sucrose + H⁺
    Note over CC: Sucrose Moves Against<br/>Its Gradient

    CC->>ST: Sucrose Diffuses Through<br/>Plasmodesmata

    Note over ST: Result:<br/>↑ Sucrose Concentration<br/>↓ Water Potential
```

This is a mechanism in plants for loading sucrose into the sieve tubes of the phloem. It involves **energy expenditure (ATP)** and **proton co-transport**. It takes place in the **companion cells**.

这是植物韧皮部装载蔗糖到筛管的一种机制，涉及**能量消耗（ATP）** 和**质子共运输**。它发生在**伴随细胞**（companion cells）中。
...
1. Active loading of sucrose into the sieve tube at the source greatly decreases the water potential in the tube. Therefore, water enters the sieve tube from nearby xylem down a water gradient by osmosis. This creates a hydrostatic pressure.
2. Unloading of sucrose from sieve tube into sink increases the water potential in the tube. Water moves out of sieve tube into nearby xylem down a water potential gradient by osmosis. This creates a low hydrostatic pressure.
...
- A **closed** **double** circulation
  1. Closed - blood **travels in blood vessels**
  2. Double circulation - blood **travels through the heart twice** on one complete circuit of the body
...
- Disposal of metabolic waste products, such as $CO_2$ and urea, out of body
...
> 可以通过*"try to be right"*这个memor来辅助记忆tricuspid valve在右边：`tri-` 开头的在右

**Cusp** 尖瓣 - To prevent the back flow of blood flow. 在valve上的结构，防止血液回流。

> [!NOTE]
>
> 在考试的时候可能要写到：“防止血液从***什么地方***流到***什么地方***。”

Oxygen diffuses into respiring body cells, become deoxygenated blood. 氧气在身体细胞中被消耗。

Thickness of the heart chambers (从细到粗):

1. **Atria** contract to pump blood into ventricles
2. **Right ventricle** contracts to pump blood into lungs
3. **Left ventricle** contracts to pump blood into the rest to body

> Left ventricle > Right ventricle > Atria (并不区分两个atria)

> [!NOTE]
>
> 当考试时要求，通过横切图，来分辨哪个chamber是哪个时，大多数都是要判断两个ventricle，的粗细程度：
>
> - 粗的那个是left ventricle
...
![image-20251222110810773](./Chapter-8.assets/image-20251222110810773.png)
...
<img src="./Chapter-8.assets/image-20251222114442021.png" alt="image-20251222114442021" style="zoom:67%;" />
...
> con**strict**ion - 用来描述血管**粗细**
>
> con**tract**ion - 用来描述肌肉**收缩**

##### Muscular Artery

**远离**心脏的Artery有更多的muscle，所以叫做muscular artery。用来regulate the blood flow。
...
**靠近**心脏的artery有更多的elastic fibre，所以叫做elastic artery，它可以在心脏跳动的时候**进行收缩**。
...
<img src="./Chapter-8.assets/image-20251222114640327.png" alt="image-20251222114640327" style="zoom:50%;" />
...
<img src="./Chapter-8.assets/image-20251222114322202.png" alt="image-20251222114322202" style="zoom:50%;" />
...
1. **Plasma** - 血浆
2. **Red blood cell** - 红细胞
3. **White blood cell** - 白细胞
4. **Platelet** - 血小板
5. **Tissue fluid** - 组织液
6. **Antibody** - 抗体
7. **Urea** - 尿素
8. **Plasma protein** - 血浆蛋白
9. **Solvent** - 溶剂
10. **Solute** - 溶质
11. **Oedema** - 水肿
12. **Immune response** - 免疫反应
13. **Pathogen** - 病原体
14. **Blood clotting** - 血液凝固
15. **Haemoglobin** - 血红蛋白
16. **Biconcave** - 双凹的
17. **Monocyte** - 单核细胞
18. **Neutrophil** - 嗜中性粒细胞
19. **Lymphocyte** - 淋巴细胞
20. **Phagocyte** - 吞噬细胞
21. **Phagocytosis** - 吞噬作用
22. **Engulf** - 吞没
23. **Haem group** - 血红素
24. **Dissociation** - 解离
25. **Alveolus/Alveoli** - 肺泡
26. **Hydrostatic pressure** - 静水压
...
| Proteins/Cells | Contains plasma proteins (e.g. albumin, antibody, fibrinogen) | Contains far fewer plasma proteins (too large)<br>No red blood cells (too large) <br>Contains some white blood cells (can squeeze through walls) |
...
1. **Hydrostatic Pressure Gradient** (blood pressure)

   > 把water从capillary中“推出”，进入到tissue fuild中

2. **Solute Concentration Gradient** (osmotic pressure, mainly due to plasma proteins)
...
| :--------- | :------------------------- | :--------------------------------- | :----------------- |
| **动脉端** | **静水压 (血压)** 胜出     | 液体**流出**毛细血管，进入组织间隙 | 高压水泵把水推出去 |
| **静脉端** | **渗透压 (蛋白吸力)** 胜出 | 液体**回流**进入毛细血管           | 海绵把水吸回来     |
...
![image-20260105114157235](./Chapter-8.assets/image-20260105114157235.png)

![image-20260105114942937](./Chapter-8.assets/image-20260105114942937.png)
...
- Fluid **leaving** capillaries at the arterial end (due to **hydrostatic pressure / blood pressure**) 在动脉端，液体因**静水压/血压**作用**渗出**毛细血管
- Fluid **returning** to capillaries at the venule end (due to **osmotic pressure** from plasma proteins) 在静脉端，液体因血浆蛋白形成的**渗透压**作用**回流**至毛细血管
...
- Haemoglobin (red coloured) *in cytoplasm* for transporting $O_2$; 4 $O_2$ molecules at most by 1 haemoglobin molecule 血红蛋白一次性最多可以携带四个氧分子
- **Biconcave** shape, for short diffusion distance
- Diameter: 7 μm, High SA:V ratio
- No nucleus, membrane bound organelles 为了携带更多的血红蛋白，红细胞中没有细胞核以及任何然后细胞膜的细胞器

<img src="./Chapter-8.assets/image-20260105115720161.png" alt="image-20260105115720161" style="zoom:50%;" />
...
![image-20260105201409981](./Chapter-8.assets/image-20260105201409981-1767615251106-1.png)

![image-20260105201617646](./Chapter-8.assets/image-20260105201617646.png)
...
- A fully saturated haemoglobin molecule can combine with 4 $O_2$ molecules
...
![image-20260106083129853](./Chapter-8.assets/image-20260106083129853.png)

当第一个氧分子与haemoglobin结合时，haemoglobin会改变形状，使它更容易和其余的三个氧气分子结合。

![image-20260106083615570](./Chapter-8.assets/image-20260106083615570.png)
...
$$
\ce{CO2 + Hb <=> Hb-CO2 (carbaminohaemoglobin)}
$$
...
1. As hydrogencarbonate ions in the blood plasma - 85%
2. As dissolved carbon dioxide molecules in the blood plasma - 5%
3. As carbaminohaemoglobin - 10%

```mermaid
pie title CO2 Transport in Blood
    "Hydrogencarbonate ions (plasma)" : 85
    "Dissolved CO2 in plasma" : 5
    "Carbaminohaemoglobin" : 10
```

#### Bohr Shift and Chloride Shift 波尔效应与氯转移

这两个“转移”是红细胞在组织中**释放氧气**并**运回二氧化碳**时发生的**协调反应**，它们密切相关。也就是说二者相辅相成，促进了气体交换。

$$
\ce{CO2 + H2O <=>[carbonic anhydrae 碳酸酐酶] H2CO3 <=> H+ + HCO3-}
$$

- **Chloride Shift** - $\ce{Cl^-}$ 移动到red blood cell的过程，并形成hydrogen carbonate ions
  ...
  - <u>**To maintain electrical neutrality**</u>, chloride ions (Cl⁻) move from the plasma **into the red blood cell**. This exchange is called the "chloride shift".
...
![image-20260107133224017](./Chapter-8.assets/image-20260107133224017.png)
...
>
> $$
> \ce{CO2 + H2O ->[Carbonic Anhydrase] H2CO3}
> $$
>
> 二氧化碳和水经过**Carbonic Anhydrase**生成碳酸。

在高partial pressure of O₂ (低partial pressure of CO₂)的地方：

1. HHb会释放$H^+$离子，随后HHb会和氧气结合，形成oxyhaemoglobin
2. 碳酸氢离子hydrogencarbonate ions会通过diffusion回到red blood cell中，并与前面被HHb释放的氢离子结合，形成碳酸carbonic acid
3. 碳酸会被会自然分解成water和carbon dioxide
4. CO₂从carbaminehaemoglobin中分离出去

```mermaid
sequenceDiagram
    participant T as Tissues
    participant P as Blood Plasma
    participant R as Red Blood Cells
    T->>P: CO2 diffuses into plasma
    Note over P,R: In plasma (5%):<br/>Remains as dissolved CO2
    P->>R: CO2 enters red blood cells
    R->>R: Combines with Hb<br/>(Carbaminohaemoglobin: 10%)
    R->>R: Converts to HCO3- via CA<br/>(85% returned to plasma)
    R->>P: HCO3- exchanged for Cl-
```
...
- 当cardiac muscle**收缩**时，被称为：**systole** 心脏收缩
- 当cardiac muscle**放松**时，被称为：**diastole** 心脏舒张

#### Cardiac Cycle

一个完整的心脏跳动周期包括三个阶段：

1. **Atrial systole** - Both atria contract

   $$
   Atrium \rightarrow Ventricle
   $$
   - Backflow of blood into the veins is prevented by **closure of the valves in the veins**

     vein中的valves会关闭，防止血液倒流

2. **Ventricular systole** - Both ventricles contract

   $$
   Ventricle \rightarrow Arteries
   $$
...
3. **Diastole** - All chambers relax

   $$
   Vein \rightarrow Atria \rightarrow Ventricles
   $$

   > 在这个阶段血液是自然流入atria和ventricles的
   - The **semi-lunar valves** are pushed shut

![image-20260113111520968](./Chapter-8.assets/image-20260113111520968.png)

#### Basic Principles

- Muscle contraction increases pressure

  > 只需要记住<u>什么地方收缩</u>，<u>什么地方的压力就会增大</u>就行了
...
<img src="./Chapter-8.assets/image-20260113112755371.png" alt="image-20260113112755371" style="zoom:67%;" />
...
1. SAN generates electrical impulse → stimulates **both atria to contract**.

   SAN发出信号，使两个atria收缩

2. Impulse is blocked by **non-conducting tissue** → cannot go directly to ventricles.

   SAN的信号被non-conducting tissue拦截

3. Impulse travels to **AVN** → delayed by **~0.1s** → allows **atria to fully empty**.

   当SAN的信号传输到AVN时，AVN会等待0.1秒（留出时间让血流流出atria）

4. AVN passes impulse to **Bundle of His / Purkyne tissue**.

   AVN将延迟后的信号传递到Purkyne tissue

5. Impulse arrives at **apex/base** of ventricles → **both ventricles contract simultaneously** → blood ejected into arteries.

   当信号到达base（ventricle的最底部）时，两个ventricles会收缩

![image-20260113120634247](./Chapter-8.assets/image-20260113120634247.png)
...
![](./Chapter-8.assets/Hemoglobin-1772684600011-3.svg)
...
![](./Chapter-8.assets/gas-exchange.svg)
...
<img src="./Chapter-8.assets/bhor.svg" style="width:40%;" />
...
- CO₂ from tissues enters the RBC and follows two main paths:
  1. Forms **Hb-CO₂ (Carbaminohaemoglobin)** by binding directly to Hb.
  2. Reacts with water to form **H₂CO₃**, which dissociates into **H⁺** and **HCO₃⁻**.
...
- **Key Reaction / Process:** Can reversibly bind to oxygen (`Hb + 4O₂ ⇌ HbO₈`) and to carbon dioxide (`Hb + CO₂ ⇌ Hb-CO₂`).
...
- **Key Reaction / Process:** `Hb + H⁺ → HHb`. The binding of H⁺ causes a **decrease in Hb's affinity for oxygen**, directly promoting oxygen release (central to the **Bohr Shift**).
...
- **Key Reaction / Process:** `Hb + 4O₂ → HbO₈`. This is a **reversible** reaction; oxygen dissociates (unloads) in tissues where the partial pressure of oxygen (pO₂) is low.
...
- **Key Reaction / Process:** `Hb + CO₂ ⇌ Hb-CO₂`. This is a **reversible** reaction; CO₂ dissociates from hemoglobin in the lungs where its partial pressure (pCO₂) is low.
...
![image-20260120133943200](./Chapter-9.assets/image-20260120133943200.png)
...
1. Ciliated epithelium containing **goblet cells** and **ciliated cells**
2. Elastic fibres
3. Mucous glands
4. Smooth muscle
5. Cartilage
...
Cilia of ciliated epithelial cells **sweep / move mucus upwards away from alveoli / lung tissue**, *towards the back of the throat*, *swallowed into stomach* where $HCl$ can destroy microorganisms.
...
![image-20260122112107128](./Chapter-9.assets/image-20260122112107128.png)

![image-20260122115132091](./Chapter-9.assets/image-20260122115132091.png)
...
1. Ciliated epithelium containing goblet cells and ciliated cells
   ...
   >
   > 1. Goblet cell先分泌mucus黏住“脏东西”
   > 2. Ciliated cell再将这些黏液推出去

2. Elastic fibre

3. Smooth muscle - not connected in bronchi

4. Mucous glands

5. Cartilage

![image-20260122112141312](./Chapter-9.assets/image-20260122112141312.png)

![image-20260122115214881](./Chapter-9.assets/image-20260122115214881.png)
...
![image-20260122112425264](./Chapter-9.assets/image-20260122112425264.png)
...
> > [!IMPORTANT]
> >
> > 考试的时候**不要**用*hair-like*这个词来描述ciliated cell / epithelium，在IG mark scheme中会reject掉这个词，直接不给分。(即使后面有提到*cilia*)
...
![image-20260121142343247](./Chapter-9.assets/image-20260121142343247.png)
...
2. Mucus traps dust, bacteria and other microorganisms
3. The cilia sweep the mucus away from lung tissue
4. The mucus and any microorganisms will then be destroyed by the acid in the stomach
...
![image-20260121143603814](./Chapter-9.assets/image-20260121143603814.png)
...
![image-20260122090700871](./Chapter-9.assets/image-20260122090700871.png)

> **Elastic Fibre** - Stretch during inhalation and recoil during exhalation of expel air

#### Cartilage

Cartilage is a type of <u>flexible skeletal tissue</u> (strong and flexible tissue), it's located in trachea and bronchus.
...
![image-20260121141847431](./Chapter-9.assets/image-20260121141847431.png)

#### Capillaries

**Capillaries** consist of a single layer of **endothelium cells**, the diameter of their lumen is very tiny (~4μm).

![image-20260122090547862](./Chapter-9.assets/image-20260122090547862.png)
...
- **Large $Surface Area : Volume$** - high diffusion rate

- **Constant flow of blood & the continuous ventilation of lungs** - maintain steep concentration gradient for $O_2$ and $CO_2$

- **Collagen fibre in alveolar walls** - provide support and prevent alveoli from bursting

- **Elastic fibre** - stretch and recoil

![image-20260122115352449](./Chapter-9.assets/image-20260122115352449.png)
...
![image-20260123091031402](./Chapter-9.assets/image-20260123091031402.png)

Bronchus:

![image-20260123091054028](./Chapter-9.assets/image-20260123091054028.png)

Small bronchiole:

![image-20260123091113883](./Chapter-9.assets/image-20260123091113883.png)
...
1. *Vibrio cholerae* enters small intestine and secretes the toxin **choleragen**
2. Choleragen stimulates epitheliad cells of the small intestine to release **chloride ions** into the lumen
3. **Water potential** in the lumen **decreases**
4. Water moves **out of blood** into small intestine by **osmosis** down the water potential gradient
...
![image-20260128133916047](./Chapter-10.assets/image-20260128133916047.png)

> #### The Malaria Life-cycle (only for extension)
>
> 1. A mosquito infected with malaria bites a human, injecting infective stages of the parasite (sporozoites) into the bloodstream. These travel to the **liver**.
>    受感染的蚊子叮咬人类，将疟原虫的感染阶段（子孢子）注入血液。子孢子随血液进入**肝脏**。
> 2. The parasites invade liver cells, multiply asexually over 6–12 days, then are released into the bloodstream to infect red blood cells.
>    疟原虫侵入肝细胞，进行无性繁殖（约6–12天），随后释放入血液，感染红细胞。
> 3. Inside red blood cells, the parasites mature and multiply every 48–72 hours, causing red blood cells to rupture, which leads to malaria symptoms.
>    在红细胞内，疟原虫每48–72小时成熟并繁殖，导致红细胞破裂，引发疟疾症状。
> 4. Some parasites develop into male and female gametes (sex cells). When another mosquito bites the infected person, it ingests these gametes.
>    部分疟原虫发育为雄性和雌性配子（生殖细胞）。当另一只蚊子叮咬感染者时，会摄入这些配子。
> 5. In the mosquito's stomach, the gametes fuse and undergo sexual reproduction, eventually producing infective stages that migrate to the mosquito's salivary glands, completing the cycle.
>    在蚊子胃中，配子结合并进行有性生殖，最终产生感染阶段（子孢子），移行至蚊子唾液腺，完成生命周期。
>
> ![image-20260128132806220](./Chapter-10.assets/image-20260128132806220.png)
...
1. Most of the time, the immune system restricts the bacteria's replication and spread. These bacteria can remain **inactive** / **latent** / **dormant** for many years.
...
2. If the immune system is **compromised** / **weakened**, the bacteria will become **active**
...
1. Aerosol borne infection so spread quickly in overcrowded housing
   气溶胶传播，因此在过度拥挤的住房中传播迅速；
2. HIV/AIDS pandemic; infection with HIV and immunodeficiency may activate dormant TB pathogen and make people more susceptible to TB
   HIV/AIDS 大流行；感染 HIV 和免疫缺陷可能激活潜伏的结核病原体，使人更容易感染结核病；
3. TB pathogen can remain latent for many years so it is difficult to diagnose it
   结核病原体可潜伏多年，因此难以诊断；
4. Treatment is long term and many patients do not complete the full course of treatment for TB, which causes some bacteria to develop resistance to drugs
   治疗周期长，许多患者未完成全程治疗，导致部分细菌产生耐药性；
5. Some strains of TB bacteria have been drug-resistant
   部分结核杆菌菌株已具有耐药性；
6. Limited education on TB prevention for general population
   普通民众的结核病预防知识普及不足；
7. Difficult to achieve herd immunity
   难以实现群体免疫。
...
1. HIV infects and destroy T-helper lymphocytes and macrophages of immune system and their numbers decrease gradually
2. Compromised immune system
3. Opportunistic infections 机会性感染, e,g, TB, happen
...
![image-20260130111116736](./Chapter-10.assets/image-20260130111116736.png)

#### Penicillin 青霉素

How penicillin works:

- Penicilin only acts on **growing bacterial cells** 青霉素只对**正在生长的细菌**起效

1. Penicillin **inhibits enzymes** and prevents the synthesis of the **cross-links between peptidoglycan molecules**.
2. To weaken cell wall
3. Cells take up water by osmosis and brust since the cell wall cannot withstand the increased turgor pressure
...
1. Random mutation enables a group of bateria can survive under the antibiotics
2. They can pass their gene to next generation / offspring
3. The offsprings then have the ability to survive with antibiotics
...
| ![image-20260201003817680](./Chapter-10.assets/image-20260201003817680.png) | ![image-20260201003829827](./Chapter-10.assets/image-20260201003829827.png) |
...
>
> $$
> \ce{Donor ->[resistance\ gene] Recipient}
> $$
>
...
1. **Overuse of antibiotics** – prescribed when not necessary 在不必要时过度用药
2. **Misuse of antibiotics** – used to treat non-bacterial infections, such as viral infections 错误用药
3. **Large-scale use of antibiotics in farming** – to prevent diseases in animals 为了预防细菌大量吃药
4. **Patients failing to complete the full course of antibiotics** – stopping treatment early 没有完成服用抗生素的整个流程

##### Consequences

1. Bacteria may **develop multiple resistance** to different antibiotics and contain several antibiotic resistance genes (e.g., MRSA). 对很多种抗生素产生抗性
2. Resistance genes may **transfer from non-pathogenic bacteria to pathogenic bacteria** through horizontal gene transfer. 让更多其他细菌产生抗性
3. Common antibiotics become **ineffective** against resistant pathogenic bacteria. 常用抗生素不再有效果
4. There is an increased need for the **invention of new antibiotics**. 对新抗生素的需求更大
...
**Non-specific immune responses** - Act uniformly against all pathogens, regardless of their different antigens. *非特异*性指不管在什么情况下的反应都一样。

**Specific immune responses** - Target specific antigens. 识别*抗原*

![image-20260203091250363](./Chapter-11.assets/image-20260203091250363.png)
...
- **Lymphocyte** - Cells responsible for the specific, adaptive immune response
  - B-lymphocytes (B cells) - Produce antibodies (B → anti**b**odies)
  - T-lymphocytes (T cells) - Coordinate immune responses and kill infected cells (T → **t**arget)
...
flowchart TD
    ...
    subgraph SG_P[Phagocytes]
        direction LR
        M
        N
    end

    subgraph SG_L[Lymphocytes]
        direction TB
        subgraph SG_T[T-Cells]
            direction LR
            TK
            TH
        end
...
![image-20260203095739043](./Chapter-11.assets/image-20260203095739043.png)

#### During a Primary Immune Response

| **Non-specific immune response (非特异性免疫应答)**                                      | **Specific immune response (特异性免疫应答)**                                                                                                                                                    |
| :--------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Phagocytes (吞噬细胞):** <br> ① Macrophages (巨噬细胞) <br> ② Neutrophils (中性粒细胞) | **Lymphocytes (淋巴细胞):** <br> ① B-lymphocytes (B细胞) <br> ② T-lymphocytes (T细胞): <br> • T-helper cells (辅助性T细胞) <br> • T-killer cells / T-cytotoxic cells (杀伤性T细胞/细胞毒性T细胞) |
| **Mode of action (作用方式):** <br> Phagocytosis (bulk transport) <br>                   | **Action:** <br> • Clonal selection (克隆选择) <br> • Clonal expansion (克隆扩增) <br> • Production of memory cells (记忆细胞的产生)                                                             |

Immune Response发生的顺序：

1. Phagocytosis
2. Antigen presentation (expression of antigens on phagocyte cell surface)
3. T-helper cell activation and production of T-killer cells
4. Activation of B-lymphocyte to produce plasma cells and memory cells
5. Production and release of antibodies

#### Mode of Action of phagocytes (Macrophages and neutrophils)

1. **Attraction** - Pathogens会产生一些化学物质，被pathogens攻击的细胞也会产生一些化学物质（例如组胺*histamine*）。这些化学物质会吸引phagocytes前往被infect的地方。
   ...
   ![image-20260203100841347](./Chapter-11.assets/image-20260203100841347.png)

2. **Detection / Recognition and attachement** - The phagecyte **detects** pathogen / **recognises** antigen.

   ![image-20260203101012301](./Chapter-11.assets/image-20260203101012301.png)

3. **Phagocytosis / endocytosis** - The phagocyte **engulfs** the pathogen to form a **phagocytic vacuole** / **phagosome**

   > **phagocytic vacuole** / **phagosome** - the pathogen inside the phagocyte

   ![image-20260203101303352](./Chapter-11.assets/image-20260203101303352.png)

4. **Fusion of lysosomes and phagocytic vacuole** - Use digestive enzymes in lysosomes to break down the pathogen.

   ![image-20260203101403726](./Chapter-11.assets/image-20260203101403726.png)
...
> **Summary**
>
> 1. Macrophage is attracted to infection site by chemotaxis.
> 2. It **detects** pathogen/recognizes antigen.
> 3. It **engulfs** the pathogen to form a phagocytic vacuole/phagosome.
> 4. Lysosomes fuse with the phagocytic vacuole.
> 5. Digestive/hydrolytic enzymes from the lysosomes digest the pathogen.
> 6. Antigen presentation.
> 7. The response is **non-specific**.

在最后有个Antigen Presentation的环节，能够展示抗原的细胞被称作**Antigen-presenting cells**，其中包括：
...
4. T-killer cells and T-helper cells have different response
   1. T-Helper cells **secrete cytokines** to stimulate <u>strong activity of macrophages</u> and responses <u>of B cells and T-killer cells</u>.
   2. T-killer cells **produce toxins** to punch holes in the cell surface membrane of infected body cells and **kill** infected body cells
...
![image-20260204133554085](./Chapter-11.assets/image-20260204133554085.png)
...
> [!NOTE]
>
> The reason of why people are often ill for several weeks after they catch a disease, even though they can make antibodies against the disease:
>
> *<u>The **primary immune response** to an antigen is slow</u>. It takes time for the immune system to:*
>
> 1. **Recognize** the antigen
> 2. Undergo **clonal selection** and **clonal expansion** of specific B and T cells
> 3. **Produce enough antibodies** to effectively fight the infection
>
> The infected people may have symptoms during this period.

> [!NOTE]
>
> 为什么当感染一个pathogen后不会对其他的pathogen产生免疫：
>
...
![image-20260204143907221](./Chapter-11.assets/image-20260204143907221.png)
...
![v](./Chapter-11.assets/image.png)

#### Functions

1. 和病毒combine到一起，让病毒无法进入host cell
2. Attach到病毒的flagella上，让它们不方便移动
3. 把许多antigen固定在一起，让它们无法自由移动
4. 和其他物体组合在一起，用于破坏细菌的细胞壁
5. 包裹细菌，让phagocyte更容易吞噬
6. 与toxins连接到一起，使它们harmless

![image-20260205112532089](./Chapter-11.assets/image-20260205112532089.png)
...
> `-mab`结尾的antibody一般都是monoclonal antibodies，例如：trastuzumab. ipilimumab, infliximab...
...
> [!TIP]
>
> How to confirm the **absence** of antigen by the addition of monoclonal antibody?
>
...
**immortal** 永生的 - Describes cells that can divide indefinitely 指细胞能够无限分裂
**fermenter** 发酵罐 - A vessel used for the large-scale growth of cells 用于大规模培养细胞的容器
...
1. Introduce antigen into a small mammal
2. Allow time for immune response to occur
3. Isolate / remove plasma cells from the spleen
4. Fuse plasma cells with myeloma / cancer cells to make hydridoma cells
5. Screen for hydridoma cell that produces desired antibody and clone it
6. Grow these hydridoma cells in a fermenter for large-scale production of Mabs

```mermaid
---
title: Production and Relations of Monoclonal Antibodies (Mabs)
---
flowchart TD
    %% Define nodes
    A[Antigen<br>抗原]
    M[Small Mammal<br>小型哺乳动物]
    PC[Plasma Cells<br>浆细胞]
    MC[Myeloma Cells<br>骨髓瘤细胞]
    H[Hybridoma Cells<br>杂交瘤细胞]
    S{Screening & Cloning<br>筛选与克隆}
    F[Fermenter<br>发酵罐]
    Mabs((Monoclonal Antibodies<br>单克隆抗体))

    %% Define relations and process flow
    A -- Injected into --> M
    M -- Immune Response --> PC
    PC -- Fusion with --> MC
    MC -- Fusion with --> PC
    ...
    H -- Undergo --> S
    S -- Selected cells grown in --> F
    F -- Large-scale production yields --> Mabs
...
>
> 1. Stimulate primary immune response in the body
> 2. Memory cells are produced
> 3. Provide long-term immunity and faster secondary immune response
> 4. Obtain artificial active immunity
> 5. Pathogens cannot lice and reproduce in vaccinated people
> 6. Transmission of the pathogen is reduced.
...
- **科学解释**： 细胞质是细胞内除细胞核以外的原生质部分，由**细胞质基质**和嵌入其中的**细胞器**组成。
...
- **位置**： 漂浮在细胞质中。
- **形状特征**： 通常呈杆状或颗粒状，有内外两层膜，内膜向内折叠形成**嵴**，大大增加了内部表面积。
- **形状如何帮助功能**： 大量的嵴为进行有氧呼吸的酶提供了巨大的附着表面，就像给工厂增加了无数个工作台，极大地提高了能量生产效率。
- **科学解释**： 进行**有氧呼吸**的主要场所，将糖类等有机物中的化学能转化为细胞直接利用的能量货币——**ATP**。
...
- **粗糙内质网 (Rough ER)**
  ...
  - **科学/通俗解释**： 因为附着核糖体，所以是**蛋白质合成、加工和折叠**的场所。 newly合成的蛋白质在这里被修饰并运输到高尔基体。可以看作是 **“蛋白质的初级加工车间”**。

- **平滑内质网 (Smooth ER)**
  - **位置**： 与粗糙内质网相连，但无核糖体附着。
  - **形状特征**： 分支管状结构，表面光滑。
  - **科学/通俗解释**： 合成**脂质**（包括磷脂和固醇）、解毒有害物质、储存钙离子。在肌肉细胞中特化为**肌质网**储存钙离子。可以看作是 **“脂质合成和解毒车间”**。

- **如何协作**： 接收来自核糖体的蛋白质或自行合成脂质，然后将这些物质包裹在**囊泡**中运输给高尔基体进行下一步加工。
...
- **科学解释**： 对来自内质网的蛋白质和脂质进行**加工、分类、包装和运输**。例如为蛋白质添加上糖链（糖基化），形成溶酶体。
...
- **科学解释**： 内含多种**水解酶**，能分解蛋白质、核酸、脂质等大分子。功能是消化吞入细胞的细菌、衰老的细胞器，并在细胞凋亡中起作用。
- **通俗解释**： **细胞的“回收站”或“消化车间”**。它负责分解废物并回收有用的原料。
- **如何协作**： 与来自细胞膜的**内吞泡**融合形成食物泡进行消化；与衰老的**线粒体**等细胞器融合并将其降解（自噬作用）。

##### **8. 中心体 (Centrosome)**

- **位置**： 通常位于细胞核附近。
- **形状特征**： 由一对相互垂直的**中心粒**和周围的蛋白基质组成。
- **科学解释**： 在细胞分裂时组装**微管**，形成**纺锤体**，牵引染色体移动，是动物细胞的微管组织中心。
...
- **通俗解释**： **植物的“储仓库和水箱”**。储存水分、养分和废物，维持细胞**膨压**，使植物保持坚挺。
...
- **位置**： 包裹细胞核的双层膜。
- **科学解释**： 将细胞核内容物与细胞质分开。其上的**核孔**控制大分子（如mRNA、蛋白质）的进出。
...
- **位置**： 充满细胞核内。
- **科学解释**： 是DNA和蛋白质的复合体。在细胞分裂时，染色质会高度螺旋化、缩短变粗，形成**染色体**。
...
- **位置**： 存在于植物细胞的细胞质中。
- **形状特征**： 通常呈椭球状，有内外两层**被膜**。内部有复杂的膜系统，这些膜堆叠成一个个饼状的**类囊体**，许多类囊体堆叠在一起形成**基粒**。
- **形状如何帮助功能**： 大量的基粒和类囊体膜为进行光合作用的色素和酶提供了巨大的附着表面，极大提高了捕捉光能和制造养料的效率。
- **科学解释**： 进行**光合作用**的细胞器，利用光能将二氧化碳和水合成为有机物（如葡萄糖），并释放氧气。
...
- **位置**： 位于相邻两个植物细胞的细胞壁之间。
- **科学解释**： 主要成分是**果胶**，像胶水一样将相邻的细胞粘合在一起。
- **通俗解释**： **细胞的“水泥”**。
...
- **这是一个总称，不是单个细胞器。**
- **科学解释**： 指一个活细胞内全部的生命物质，包括**细胞膜、细胞质和细胞核**。
- **通俗解释**： **“活细胞的全部内容”**。
...
1. **总部（细胞核）** 里的**蓝图（染色质）** 被复制成指令（mRNA）。
2. 指令通过**核孔**送出，到达**装配机器（核糖体）**。
3. 核糖体在**初级加工车间（粗糙内质网）** 生产出蛋白质半成品。
4. 半成品被**运输小泡**送到**邮局（高尔基体）** 进行精加工、贴标签和打包。
5. 邮局发出包裹（**囊泡**），这些包裹通过**高速公路（微管）** 被运往：
    - **细胞膜**： 出口到细胞外。
    - **溶酶体**： 作为消化工具。
6. 整个工厂需要的能量由**发电站（线粒体）** 提供。
7. 工厂的边界由**看门人（细胞膜）** 和**外墙（细胞壁-植物）** 守护。
8. 所有这一切都发生在**工厂车间（细胞质）** 里。
...
1. Instructions (mRNA) are copied from the **blueprints (chromatin)** in **Headquarters (Nucleus)**.
2. Instructions exit through **Nuclear Pores** and go to the **Assembly Machines (Ribosomes)**.
3. Ribosomes on the **Assembly Line (Rough ER)** produce protein products.
4. Products are sent via **Transport Trucks (Vesicles)** to the **Post Office/Packaging Plant (Golgi Apparatus)** for finishing, labeling, and packaging.
5. The Golgi sends out packages (**Vesicles**) that travel on **Highways (Microtubules)** to be delivered to:
    - The **Cell Membrane** for export.
    - **Lysosomes** for use as digestive tools.
6. The entire factory is powered by the **Power Plant (Mitochondria)**.
7. The factory's perimeter is guarded by the **Gatekeeper (Cell Membrane)** and **Exterior Wall (Cell Wall - in plants)**.
8. All of this happens within the **Factory Floor (Cytoplasm)**.
...
<th>Description</th>
<th>Bonds Involved</th>
<th>Key Features</th>
</tr>
</thead>
<tbody>
<tr>
<td rowspan="2"><strong>Primary Structure</strong></td>
<td>Sequence of amino acids in a polypeptide chain</td>
<td>Peptide bonds (√)</td>
<td>• 40% of amino acids are glutamine<br>• Determines final 3D shape<br>• Covalent peptide bonds</td>
</tr>
<tr>
<td>氨基酸的排列顺序</td>
<td>肽键 (√)</td>
<td>• 通过肽键共价连接<br>• 决定最终三维形状</td>
</tr>
<tr>
<td rowspan="2"><strong>Secondary Structure</strong></td>
<td>Local folding of polypeptide backbone<br>(α-helix and β-pleated sheets)</td>
<td>Hydrogen bonds (√)</td>
<td>• Short helical sections with pleated sheets<br>• C=O and N-H groups in backbone<br>• No R group involvement</td>
</tr>
<tr>
<td>多肽链主链骨架的局部空间结构</td>
<td>氢键 (√)</td>
<td>• 不涉及R基团<br>• 主链C=O与N-H间的氢键</td>
</tr>
<tr>
<td rowspan="2"><strong>Tertiary Structure</strong></td>
<td>3D folding of a single polypeptide chain</td>
<td>Hydrogen bonds (√)<br>Disulfide bonds (√)<br>Ionic bonds (√)<br>Hydrophobic interactions (√)</td>
<td>• Hydrophobic amino acids inside<br>• Folding of secondary structures<br>• Interactions between R groups</td>
</tr>
<tr>
<td>一条多肽链的完整三维结构</td>
<td>氢键 (√)<br>二硫键 (√)<br>离子键 (√)<br>疏水相互作用 (√)</td>
<td>• 疏水氨基酸不在表面<br>• 涉及R基团相互作用</td>
</tr>
<tr>
</tr>
<tr>
<td rowspan="2"><strong>Quaternary Structure</strong></td>
<td>Assembly of multiple polypeptide chains</td>
<td>Hydrogen bonds (√)<br>Disulfide bonds (√)<br>Ionic bonds (√)<br>Hydrophobic interactions (√)</td>
<td>• Three polypeptide chains<br>• May include non-peptide components<br>• Same bonds as tertiary structure</td>
</tr>
<tr>
<td>多条多肽链的组装</td>
<td>氢键 (√)<br>二硫键 (√)<br>离子键 (√)<br>疏水相互作用 (√)</td>
<td>• 两条以上多肽链构成<br>• 可能包括非肽成分</td>
</tr>
</tbody>
</table>
...
- [Chapter 1 - Cell Organelles](#chapter-1---cell-organelles)
  - [显微镜](#显微镜)
    - [制作临时的样本](#制作临时的样本)
  ...
  - [细胞器的功能](#细胞器的功能)
    - [本章重点内容](#本章重点内容)
    - [Cell Surface Membrane / plasma Membrane 细胞膜](#cell-surface-membrane--plasma-membrane-细胞膜)
    - [Cell Wall 细胞壁](#cell-wall-细胞壁)
    - [Plasmodesma (plural: plasmodesmata) 胞间连丝](#plasmodesma-plural-plasmodesmata-胞间连丝)
    - [Cytoplasm 细胞质](#cytoplasm-细胞质)
    - [Nucleus (plural: nuclei) 细胞核](#nucleus-plural-nuclei-细胞核)
    - [Mitochondrion (plural: mitochondria) 线粒体](#mitochondrion-plural-mitochondria-线粒体)
    - [Chloroplast 叶绿体](#chloroplast-叶绿体)
    - [Vacuole 液泡](#vacuole-液泡)
    - [Endoplasmic Reticulum 内质网](#endoplasmic-reticulum-内质网)
    - [Golgi body / apparatus 高尔基体](#golgi-body--apparatus-高尔基体)
    - [Ribosome 核糖体](#ribosome-核糖体)
    - [Lysosome 溶酶体](#lysosome-溶酶体)
    - [Centrosome 中心体](#centrosome-中心体)
    - [Microtubules 微管](#microtubules-微管)
    - [Flagellum (plural: flagella) and cilium (plural: cilia) 鞭毛和纤毛](#flagellum-plural-flagella-and-cilium-plural-cilia-鞭毛和纤毛)
    - [Microvillus (plural: microvilli) 微绒毛](#microvillus-plural-microvilli-微绒毛)
    - [Cell surface membrane 细胞膜](#cell-surface-membrane-细胞膜)
  - [Prokaryotic and bacterial cells 原核细胞和细菌细胞](#prokaryotic-and-bacterial-cells-原核细胞和细菌细胞)
    - [重点信息](#重点信息)
    - [主要结构](#主要结构)
    - [Prokaryotes vs Eukaryotes](#prokaryotes-vs-eukaryotes)
    - [Common structural features](#common-structural-features)
  - [Virus 病毒](#virus-病毒)
  - [单元总结](#单元总结)
- [Chapter 2 - Biological Molecule](#chapter-2---biological-molecule)
  - [Chapter Outline](#chapter-outline)
  - [Biochemistry](#biochemistry)
    - [Monomers and Polymers](#monomers-and-polymers)
    - [Chemical Structures](#chemical-structures)
    - [Hydrogen Bond](#hydrogen-bond)
  - [Bonds Summary](#bonds-summary)
    - [Glycosidic Bond (糖苷键)](#glycosidic-bond-糖苷键)
    - [Ester Bond (酯键)](#ester-bond-酯键)
    - [Peptide Bond (肽键)](#peptide-bond-肽键)
    - [Hydrogen Bond (氢键)](#hydrogen-bond-氢键)
    - [Disulfide Bond (二硫键)](#disulfide-bond-二硫键)
    - [Ionic Bond (离子键)](#ionic-bond-离子键)
    - [Hydrophobic Interaction (疏水相互作用)](#hydrophobic-interaction-疏水相互作用)
    - [Phosphodiester Bond (磷酸二酯键)](#phosphodiester-bond-磷酸二酯键)
  - [Water](#water)
    - [Water as Solvent](#water-as-solvent)
    - [High Specific Heat Capacity](#high-specific-heat-capacity)
    - [High Latent Heat of Vaporisation](#high-latent-heat-of-vaporisation)
  ...
  - [Polysaccharide](#polysaccharide)
    ...
    - [Glycogen 糖原](#glycogen-糖原)
    - [Cellulose 纤维素](#cellulose-纤维素)
  - [Testing the Presence of Carbohydrates](#testing-the-presence-of-carbohydrates)
    - [Iodine Test](#iodine-test)
    - [Benedict's Test](#benedicts-test)
    - [Testing the Presence of Non-reducing Sugar](#testing-the-presence-of-non-reducing-sugar)
  - [Lipid 脂质](#lipid-脂质)
    - [Fatty Acid](#fatty-acid)
    - [Triglycerides](#triglycerides)
      - [Functions of Triglyceride](#functions-of-triglyceride)
    - [Phospholipids](#phospholipids)
    - [Summary](#summary)
  - [Testing the Lipids](#testing-the-lipids)
  - [Protein](#protein)
    - [R groups](#r-groups)
    - [Polar and Non-polar Amino acids](#polar-and-non-polar-amino-acids)
    - [Formation of Peptide bond](#formation-of-peptide-bond)
  ...
  - [Protien's Shape (Globular and Fibrous)](#protiens-shape-globular-and-fibrous)
    - [Globular Protein - Haemoglobin](#globular-protein---haemoglobin)
    - [Fibrous Protein - Collagen](#fibrous-protein---collagen)
    - [Summary Table](#summary-table)
  - [Testing the Proteins](#testing-the-proteins)
  - [Types of protein and their functions](#types-of-protein-and-their-functions)
  - [Summary](#summary-1)
- [Chapter 3 - Enzymes](#chapter-3---enzymes)
  - [Chapter Outline](#chapter-outline-1)
  - [Structure and Features of Enzymes](#structure-and-features-of-enzymes)
    - [Intracellular and Extracellular Enzymes](#intracellular-and-extracellular-enzymes)
  - [Mode of Action of Enzymes](#mode-of-action-of-enzymes)
    - [The lock-and-key Hypothesis](#the-lock-and-key-hypothesis)
    - [The induced-fit Hypothesis](#the-induced-fit-hypothesis)
    - [Differences between Lock-and-Key \& Induced-Fit 两种假说的区别](#differences-between-lock-and-key--induced-fit-两种假说的区别)
  - [Factors Affecting Enzyme Activity](#factors-affecting-enzyme-activity)
    - [Describe the Graph](#describe-the-graph)
    - [Explain the Graph](#explain-the-graph)
    - [Enzyme Concentration](#enzyme-concentration)
    - [How to Break the Bonds in Enzyme (Protein)](#how-to-break-the-bonds-in-enzyme-protein)
    - [Temperature's Effect](#temperatures-effect)
    - [pH's Effect](#phs-effect)
  - [Investigating Enzyme-catalysed Reactions](#investigating-enzyme-catalysed-reactions)
    - [How to Measure Reaction Rate 如何测量反应速率](#how-to-measure-reaction-rate-如何测量反应速率)
    - [Using a Colorimeter 使用比色计](#using-a-colorimeter-使用比色计)
  - [Comparing Enzyme Affinity](#comparing-enzyme-affinity)
    - [Michaelis-Menten Constant ((K\_m)) 米氏常数](#michaelis-menten-constant-k_m-米氏常数)
  - [Enzyme Inhibitors](#enzyme-inhibitors)
    - [Comparison of Inhibitors 抑制剂比较](#comparison-of-inhibitors-抑制剂比较)
    - [End-Product Inhibition 终产物抑制](#end-product-inhibition-终产物抑制)
  - [Immobilised Enzymes 固定化酶](#immobilised-enzymes-固定化酶)
    - [Methods of Immobilisation 固定化方法](#methods-of-immobilisation-固定化方法)
    - [Advantages of Immobilised Enzymes 固定化酶的优点（补充）](#advantages-of-immobilised-enzymes-固定化酶的优点补充)
    - [Practical Application: Lactose-Free Milk 实际应用：无乳糖牛奶](#practical-application-lactose-free-milk-实际应用无乳糖牛奶)
  - [实验设计与变量控制](#实验设计与变量控制)
    - [Types of Variables 变量类型](#types-of-variables-变量类型)
    - [How to Vary Independent Variables 如何改变自变量](#how-to-vary-independent-variables-如何改变自变量)
  - [复习要点总结](#复习要点总结)
  - [SUMMARY](#summary-2)
- [Chapter 4 - Cell Membranes and Transport](#chapter-4---cell-membranes-and-transport)
  - [Structure of cell membrane](#structure-of-cell-membrane)
    - [Fluid mosaic model 流动镶嵌模型](#fluid-mosaic-model-流动镶嵌模型)
    - [Feature and Role of Cell Membrane](#feature-and-role-of-cell-membrane)
    - [The Factors that Influence the Fluidity](#the-factors-that-influence-the-fluidity)
  - [The roles of the molecules found in membranes](#the-roles-of-the-molecules-found-in-membranes)
    - [Proteins](#proteins)
    - [Glycoproteins and Glycolipids](#glycoproteins-and-glycolipids)
  - [Cell signalling](#cell-signalling)
  - [Movement of Substances Across Membranes](#movement-of-substances-across-membranes)
    - [Diffusion](#diffusion)
  ...
  - [SUMMARY](#summary-3)
- [Chapter 5 - The Mitosis Cell Cycle](#chapter-5---the-mitosis-cell-cycle)
  - [Mitosis Cell Cycle](#mitosis-cell-cycle)
    - [Interphase](#interphase)
      - [$ G\_1 $phase](#-g_1-phase)
      - [$ S $ phase](#-s--phase)
      - [$ G\_2 $ phase](#-g_2--phase)
    - [Mitosis (second phase in the cycle)](#mitosis-second-phase-in-the-cycle)
      - [Prophase](#prophase)
      - [Metaphase](#metaphase)
      - [Anaphase](#anaphase)
      - [Telophase](#telophase)
  ...
  - [Chromosome](#chromosome)
    - [Telomere 端粒](#telomere-端粒)
    - [Chromatid - 染色单体](#chromatid---染色单体)
  - [Stem Cell 干细胞](#stem-cell-干细胞)
  - [Cancerous Cells](#cancerous-cells)
  - [SUMMARY](#summary-4)
- [Chapter 6 - Gene](#chapter-6---gene)
  - [Chapter Outline](#chapter-outline-2)
  - [Nucleic Acid](#nucleic-acid)
    ...
    - [RNA Structure](#rna-structure)
      ...
      - [tRNA](#trna)
      - [rRNA](#rrna)
  - [Semi-conservative DNA replication](#semi-conservative-dna-replication)
    - [Meselson \& Stahl's Experiment](#meselson--stahls-experiment)
    - [Key Terms](#key-terms)
  - [Protein Synthesis](#protein-synthesis)
    - [Transcription](#transcription)
    - [Translation](#translation)
  - [Gene Mutations](#gene-mutations)
- [Chapter 7 - Plant Transportation](#chapter-7---plant-transportation)
  - [Plant transport system](#plant-transport-system)
    - [Xylem](#xylem)
    - [Phloem](#phloem)
  - [Water Uptake and Transpiration](#water-uptake-and-transpiration)
    - [1. Transpiration](#1-transpiration)
    - [2. Water Evaporation](#2-water-evaporation)
    - [3. Water Movement from xylem in leaf to mesophyll cells](#3-water-movement-from-xylem-in-leaf-to-mesophyll-cells)
    - [4. Tension and transpirational pull](#4-tension-and-transpirational-pull)
    - [5. Water uptake](#5-water-uptake)
    - [Water Pathway](#water-pathway)
      - [Lignin and Suberin](#lignin-and-suberin)
      - [Endodermis](#endodermis)
    - [How the structure of xylem vessles is suited to their function](#how-the-structure-of-xylem-vessles-is-suited-to-their-function)
  - [Active Loading and Translocation](#active-loading-and-translocation)
    - [Process of Translocation (Transport in Phloem)](#process-of-translocation-transport-in-phloem)
    - [Active Loading of Sucrose](#active-loading-of-sucrose)
  - [Xerophyte](#xerophyte)
  - [Experiments](#experiments)
  - [Vocabulary Table](#vocabulary-table)
- [Chapter 8 - Transport in Mammals](#chapter-8---transport-in-mammals)
  - [Chapter Outline](#chapter-outline-3)
  - [Key Terms](#key-terms-1)
  - [The Circulatory System](#the-circulatory-system)
  - [Heart](#heart)
    - [Addition Circulatory Systems](#addition-circulatory-systems)
  - [Blood Vessels](#blood-vessels)
    - [Artery (and arteriole)](#artery-and-arteriole)
      - [Muscular Artery](#muscular-artery)
      - [Elastic Artery](#elastic-artery)
    - [Vein (and venule)](#vein-and-venule)
    - [Capillary](#capillary)
  - [Tissue Fluid](#tissue-fluid)
    - [Keywords](#keywords)
    - [Introduction](#introduction)
    - [Two opposing forces for formation of tissue fluid](#two-opposing-forces-for-formation-of-tissue-fluid)
    - [Oedema 水肿](#oedema-水肿)
  - [Components of Blood](#components-of-blood)
    - [Red Blood Cell](#red-blood-cell)
    - [White Blood Cell](#white-blood-cell)
  - [Transport of Oxygen and Carbon Dioxide](#transport-of-oxygen-and-carbon-dioxide)
    - [Oxygen](#oxygen)
    - [Carbon dioxide](#carbon-dioxide)
    - [Bohr Shift and Chloride Shift 波尔效应与氯转移](#bohr-shift-and-chloride-shift-波尔效应与氯转移)
  - [Heart](#heart-1)
    - [Cardiac Cycle](#cardiac-cycle)
    - [Basic Principles](#basic-principles)
    - [Four Structures in the Control of Cardiac Cycle](#four-structures-in-the-control-of-cardiac-cycle)
    - [Heart Sound](#heart-sound)
  - [Appendix](#appendix)
    - [Diagrams](#diagrams)
      - [Overview of Hemoglobin Forms and Transitions](#overview-of-hemoglobin-forms-and-transitions)
      - [Gas Exchange at Respiring Tissues (CO₂ Loading \& O₂ Unloading)](#gas-exchange-at-respiring-tissues-co-loading--o-unloading)
      - [The Bohr Shift Mechanism](#the-bohr-shift-mechanism)
      - [The Chloride Shift Mechanism](#the-chloride-shift-mechanism)
      - [Gas Exchange in the Lungs (Reverse Processes)](#gas-exchange-in-the-lungs-reverse-processes)
    - [Blood Transport Compounds](#blood-transport-compounds)
      - [Hb (Hemoglobin / 血红蛋白)](#hb-hemoglobin--血红蛋白)
      - [HHb (Hemoglobinic Acid / 血红蛋白酸)](#hhb-hemoglobinic-acid--血红蛋白酸)
      - [HbO₈ / HbO₂ (Oxyhemoglobin / 氧合血红蛋白)](#hbo--hbo-oxyhemoglobin--氧合血红蛋白)
      - [Hb-CO₂ (Carbaminohaemoglobin / 氨基甲酰血红蛋白)](#hb-co-carbaminohaemoglobin--氨基甲酰血红蛋白)
      - [Bohr Shift (波尔效应)](#bohr-shift-波尔效应)
      - [Chloride Shift (氯转移)](#chloride-shift-氯转移)
- [Chapter 9 - Gas Exchange](#chapter-9---gas-exchange)
  - [Chapter Outline](#chapter-outline-4)
  - [Human gas exchange system](#human-gas-exchange-system)
    - [Distribution of different components in trachea 气管](#distribution-of-different-components-in-trachea-气管)
    - [Distribution of different components in Bronchi 支气管](#distribution-of-different-components-in-bronchi-支气管)
    - [Distribution of different components in Bronchiole 细支气管](#distribution-of-different-components-in-bronchiole-细支气管)
  - [Key Structures](#key-structures)
    ...
    - [Alveoli](#alveoli)
  - [Plan Diagram / Low Power Drawing](#plan-diagram--low-power-drawing)
  - [Appendix](#appendix-1)
    - [Distinguishing Between Trachea, Bronchus, and Bronchiole](#distinguishing-between-trachea-bronchus-and-bronchiole)
- [Chapter 10 - Infectious Diseases](#chapter-10---infectious-diseases)
  - [Chapter Outline](#chapter-outline-5)
  - [Key Terms](#key-terms-2)
    ...
    - [Examples](#examples)
  - [Pathogens](#pathogens)
    - [Cholera 霍乱](#cholera-霍乱)
      - [Process of Infection](#process-of-infection)
    - [Malaria 疟疾](#malaria-疟疾)
    - [Tuberculosis (TB) 肺结核](#tuberculosis-tb-肺结核)
      - [Disease-causing process](#disease-causing-process)
      - [Reasons for Increase of TB Cases / Difficulty of Controlling TB](#reasons-for-increase-of-tb-cases--difficulty-of-controlling-tb)
    - [HIV/AIDS 艾滋病](#hivaids-艾滋病)
      - [Disease-causing process](#disease-causing-process-1)
  - [Antibiotics](#antibiotics)
    - [Penicillin 青霉素](#penicillin-青霉素)
    - [Antibiotic resistance genes](#antibiotic-resistance-genes)
      - [Causes](#causes)
      - [Consequences](#consequences)
      - [How to Reduce the Development of Antibiotic Resistance](#how-to-reduce-the-development-of-antibiotic-resistance)
- [Chapter 11 - Immunity](#chapter-11---immunity)
  - [Chapter Outline](#chapter-outline-6)
  - [Key Terms](#key-terms-3)
  - [Defence Against Disease](#defence-against-disease)
    - [Three Lines of Defense Against Pathogens by the Immune System](#three-lines-of-defense-against-pathogens-by-the-immune-system)
    - [During a Primary Immune Response](#during-a-primary-immune-response)
    - [Mode of Action of phagocytes (Macrophages and neutrophils)](#mode-of-action-of-phagocytes-macrophages-and-neutrophils)
    - [B Cells - Produce Antibodies](#b-cells---produce-antibodies)
      - [Primary Immune Response - Action of B cells](#primary-immune-response---action-of-b-cells)
    - [T Cells - Coordinate Immune Responses](#t-cells---coordinate-immune-responses)
      - [Primary Immune Response - Action of T cells](#primary-immune-response---action-of-t-cells)
  ...
  - [Antibodies](#antibodies)
    ...
    - [Monoclonal Antibodies](#monoclonal-antibodies)
      - [Keywords](#keywords-1)
      - [The Production of Monoclonal Antibodies](#the-production-of-monoclonal-antibodies)
    - [Diagnosis process](#diagnosis-process)
    - [Treatment](#treatment)
    - [Problems](#problems)
      - [Solutions](#solutions)
  - [Vaccine](#vaccine)
    - [Vaccination Programmes](#vaccination-programmes)
- [Practical Exam](#practical-exam)
  - [How to draw a table to record the result](#how-to-draw-a-table-to-record-the-result)
  - [Overview](#overview)
    - [**一、 通用细胞器（在动植物细胞中常见）**](#一-通用细胞器在动植物细胞中常见)
      - [**1. 细胞膜 (Cell Membrane)**](#1-细胞膜-cell-membrane)
      - [**2. 细胞质 (Cytoplasm)**](#2-细胞质-cytoplasm)
      - [**3. 线粒体 (Mitochondrion)**](#3-线粒体-mitochondrion)
      - [**4. 核糖体 (Ribosomes)**](#4-核糖体-ribosomes)
      - [**5. 内质网 (Endoplasmic Reticulum, ER)**](#5-内质网-endoplasmic-reticulum-er)
      - [**6. 高尔基体 (Golgi Apparatus)**](#6-高尔基体-golgi-apparatus)
      - [**7. 溶酶体 (Lysosome)**](#7-溶酶体-lysosome)
      - [**8. 中心体 (Centrosome)**](#8-中心体-centrosome)
      - [**9. 液泡 (Vacuole)**](#9-液泡-vacuole)
    - [**二、 细胞核结构 (Nucleus)**](#二-细胞核结构-nucleus)
      - [**10. 细胞核 (Nucleus)**](#10-细胞核-nucleus)
      - [**11. 核被膜 (Nuclear Envelope)**](#11-核被膜-nuclear-envelope)
      - [**12. 核孔 (Nuclear Pore)**](#12-核孔-nuclear-pore)
      - [**13. 染色质 (Chromatin)**](#13-染色质-chromatin)
      - [**14. 核仁 (Nucleolus)**](#14-核仁-nucleolus)
    - [**三、 植物特有结构**](#三-植物特有结构)
      - [**15. 叶绿体 (Chloroplast)**](#15-叶绿体-chloroplast)
      - [**16. 细胞壁 (Cell Wall)**](#16-细胞壁-cell-wall)
      - [**17. 胞间连丝 (Plasmodesma)**](#17-胞间连丝-plasmodesma)
      - [**18. 中胶层 (Middle Lamella)**](#18-中胶层-middle-lamella)
    - [**四、 细胞骨架与附属结构**](#四-细胞骨架与附属结构)
      - [**19. 微绒毛 (Microvilli)**](#19-微绒毛-microvilli)
      - [**20. 微管 (Microtubules)**](#20-微管-microtubules)
      - [**21. 原生质 (Protoplasm)**](#21-原生质-protoplasm)
    - [**总结：它们如何协同工作？**](#总结它们如何协同工作)
    - [**1. General Organelles (Common in Animal and Plant Cells)**](#1-general-organelles-common-in-animal-and-plant-cells)
      - [**1. Cell Membrane (Plasma Membrane)**](#1-cell-membrane-plasma-membrane)
      - [**2. Cytoplasm**](#2-cytoplasm)
      - [**3. Mitochondrion (pl. Mitochondria)**](#3-mitochondrion-pl-mitochondria)
      - [**4. Ribosomes**](#4-ribosomes)
      - [**5. Endoplasmic Reticulum (ER)**](#5-endoplasmic-reticulum-er)
      - [**6. Golgi Apparatus (Golgi Body / Golgi Complex)**](#6-golgi-apparatus-golgi-body--golgi-complex)
      - [**7. Lysosome**](#7-lysosome)
      - [**8. Centrosome**](#8-centrosome)
      - [**9. Vacuole**](#9-vacuole)
    - [**2. Nucleus Structures**](#2-nucleus-structures)
      - [**10. Nucleus**](#10-nucleus)
      - [**11. Nuclear Envelope (Nuclear Membrane)**](#11-nuclear-envelope-nuclear-membrane)
      - [**12. Nuclear Pore**](#12-nuclear-pore)
      - [**13. Chromatin**](#13-chromatin)
      - [**14. Nucleolus (pl. Nucleoli)**](#14-nucleolus-pl-nucleoli)
    - [**3. Plant-Specific Structures**](#3-plant-specific-structures)
      - [**15. Chloroplast**](#15-chloroplast)
      - [**16. Cell Wall**](#16-cell-wall)
      - [**17. Plasmodesma (pl. Plasmodesmata)**](#17-plasmodesma-pl-plasmodesmata)
      - [**18. Middle Lamella**](#18-middle-lamella)
    - [**4. Cytoskeleton \& Appendages**](#4-cytoskeleton--appendages)
      - [**19. Microvilli (sing. Microvillus)**](#19-microvilli-sing-microvillus)
      - [**20. Microtubules**](#20-microtubules)
      - [**21. Protoplasm**](#21-protoplasm)
    - [**Summary: How Do They Work Together?**](#summary-how-do-they-work-together)
- [Protein Structure Levels Summary](#protein-structure-levels-summary)
